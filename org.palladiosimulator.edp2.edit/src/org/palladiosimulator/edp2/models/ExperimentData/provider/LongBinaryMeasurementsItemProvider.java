...
public class LongBinaryMeasurementsItemProvider extends DataSeriesItemProvider {
    ...
    protected void addStorageUnitPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_LongBinaryMeasurements_storageUnit_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_LongBinaryMeasurements_storageUnit_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_LongBinaryMeasurements_type") : this
