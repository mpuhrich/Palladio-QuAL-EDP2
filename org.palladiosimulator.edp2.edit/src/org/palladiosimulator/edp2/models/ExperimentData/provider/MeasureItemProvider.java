 ...
 * @generated
 */
public class MeasureItemProvider extends IdentifierItemProvider {
    /**
     ...
     * @generated
     */
    public MeasureItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addExperimentSettingsPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_Measure_experimentSettings_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_Measure_experimentSettings_feature",
    ...
    protected void addMetricPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_Measure_metric_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Measure_metric_feature", "_UI_Measure_type"),
    ...
    protected void addMeasuringPointPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_Measure_measuringPoint_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Measure_measuringPoint_feature",
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Measure"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((Measure) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_Measure_type") : this
