...
ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                MeasuringpointActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return MeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (MeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) MeasuringpointActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("measuringpoint-settings"));
        toolBarManager.add(new Separator("measuringpoint-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                EDP2EditorPlugin.INSTANCE.getString("_UI_MeasuringpointEditor_menu"),
                "org.palladiosimulator.edp2.models.measuringpointMenuID");
        ...
        //
        this.createChildMenuManager = new MenuManager(EDP2EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                EDP2EditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
