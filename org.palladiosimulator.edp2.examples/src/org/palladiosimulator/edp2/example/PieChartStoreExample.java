...
public class PieChartStoreExample {
    ...
    private void createExample() {
        ...
        ldRepo.getDescriptions().addAll(exampleData.createExampleBaseMetricDescriptions(ldRepo.getDescriptions()));
        ldRepo.getDescriptions().addAll(exampleData.createExampleMetricSetDescriptions(ldRepo.getDescriptions()));
    ...
    public static void main(final String[] args) {
        final PieChartStoreExample example = new PieChartStoreExample();
        example.run();
    }
}
