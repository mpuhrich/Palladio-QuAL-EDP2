...
ModifyListener {
    ...
    public WarmupFilterSettingsPage(final AbstractDataSource source) {
        super(PAGE_NAME);
        this.source = source;
        ...
        final MeasurementsDao<?,? extends Quantity> dao = MeasurementsUtility
                .getMeasurementsDao(source.getOutput().get(0));
    ...
    private void setDroppedValuesPercentage(final float droppedValuesPercentage) {
    ...
    private void setDroppedValuesAbsolute(final int droppedValuesAbsolute) {
    ...
    public void createControl(final Composite parent) {
        ...
        final Label perLabel = new Label(composite, SWT.NONE);
        ...
        final Label absLabel = new Label(composite, SWT.NONE);
    ...
    public boolean canFlipToNextPage() {
        final IStatus currentPageStatus = updatePageStatus();
    ...
    public WarmupFilter getFilter() {
        final WarmupFilter filter = new WarmupFilter();
        final HashMap<String, Object> properties = filter.getProperties();
