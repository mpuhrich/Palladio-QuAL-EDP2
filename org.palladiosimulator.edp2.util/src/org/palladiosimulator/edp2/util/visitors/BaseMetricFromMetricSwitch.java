...
MetricSpecSwitch<BaseMetricDescription[]> {

    @Override
    public BaseMetricDescription[] caseBaseMetricDescription(
            final BaseMetricDescription object) {
    ...
    public BaseMetricDescription[] caseMetricSetDescription(
            final MetricSetDescription object) {
        ...
        for (final MetricDescription description : object.getSubsumedMetrics()) {
            final BaseMetricDescription[] baseDescriptions = new BaseMetricFromMetricSwitch()
