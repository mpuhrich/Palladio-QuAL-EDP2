...
implements IDataSink {
    ...
    public AbstractTransformation(final AbstractDataSource source) {
        if (source != null) {
            setSource(source);
        }
    }
     ...
     */
    @Override
    public void setSource(final AbstractDataSource source) {
        if (this.source != null) {
    ...
    private void setOriginalMeasurementsRange(
            final MeasurementsRange originalMeasurementsRange) {
     ...
     */
    public boolean validProperties(final HashMap<String, Object> newProperties,
            final String key) {
