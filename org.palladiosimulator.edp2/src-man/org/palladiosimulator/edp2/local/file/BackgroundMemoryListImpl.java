...
implements BackgroundMemoryList<V,Q>
{
     ...
     */
    public BackgroundMemoryListImpl(final String absoluteFilename, final Serializer<V> serialiser, final BinaryRepresentation binaryRepresentation, final Unit<Q> unit) throws IOException {
     ...
     * @throws IOException Thrown if file IO fails.
     */
    public BackgroundMemoryListImpl(final String absoluteFilename, final Serializer<V> serialiser, final int chunkSize, final BinaryRepresentation binaryRepresentation, final Unit<Q> unit) throws IOException {
    ...
    public synchronized Measure<V,Q> get(final int index) {
        ...
        try {
            ...
            if (binaryRepresentation == BinaryRepresentation.LONG) {
                return (Measure<V, Q>) Measure.valueOf((Long)chunks.get((int)(index - chunks.indexStartingElementForChunk())), unit);
            }
            if (binaryRepresentation == BinaryRepresentation.DOUBLE) {
                return (Measure<V, Q>) Measure.valueOf((Double)chunks.get((int)(index - chunks.indexStartingElementForChunk())), unit);
            }
            if (binaryRepresentation == BinaryRepresentation.IDENTIFIER) {
                return new IdentifierMeasure((Identifier)chunks.get((int)(index - chunks.indexStartingElementForChunk())), unit);
            }
