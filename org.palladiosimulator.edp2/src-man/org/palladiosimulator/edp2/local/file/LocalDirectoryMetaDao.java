...
public class LocalDirectoryMetaDao extends MetaDaoImpl {
    ...
    private final LocalDirectoryRepository managedRepo;
    ...
    public LocalDirectoryMetaDao(final LocalDirectoryRepository repo) {
        ...
        final Adapter descAdapter = new LocalDirectoryMetaResourceAdapter(repo,
        ...
        final Adapter expGroupAdapter = new LocalDirectoryMetaResourceAdapter(repo,
    ...
    public void open() throws DataNotAccessibleException {
        ...
        // open directory
        try {
            final File directory = convertUriStringToFile(managedRepo.getUri());
            if (managedRepo.getRepositories() == null) {
