 ...
 * <!-- end-user-doc -->
 * 
 * <!-- begin-model-doc --> Experiment runs contain the collected data (results) for each
 * replication of an experiment. The data is collected for each sensor declared in the experiment
 * setting. There is one instance of collected data for each declared sensor.
 * 
 * The time when the experiment was started and how long it took are stored as attributes. The end
 * of the experiment run can be calculated by: endTime = startTime + duration.
 * self.experimentSetting.measure->size()=measurements->size() and
 * self.experimentSetting.measure->forAll
 * (s|self.measurements->collect(measure)->select(s2|s=s2)->size()=1) <!-- end-model-doc -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.ExperimentRun#getMeasurements <em>
 * Measurements</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.ExperimentRun#getStartTime <em>Start
 * Time</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.ExperimentRun#getDuration <em>
 * Duration</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.ExperimentRun#getExperimentSetting
...
public interface ExperimentRun extends Identifier, Propertyable {
     ...
     * <em>Experiment Run</em>}'. <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.palladiosimulator.edp2.models.ExperimentData.ExperimentDataPackage#getExperimentRun_Measurements()
     ...
     * @see org.palladiosimulator.edp2.models.ExperimentData.ExperimentDataPackage#getExperimentRun_StartTime()
     ...
     * @see org.palladiosimulator.edp2.models.ExperimentData.ExperimentDataPackage#getExperimentRun_Duration()
     ...
     * <em>Experiment Runs</em>}'. <!-- begin-user-doc -->
     * <p>
