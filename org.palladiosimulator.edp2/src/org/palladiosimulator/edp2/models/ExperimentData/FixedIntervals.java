...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Fixed Intervals</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Describes the different aggregation intervals in detail. Includes start
 * and end of each interval as well as two special intervals to reflect outliers. Intervals are not
 * allowed to contain no value, there has to be a default. The default value is also saved to disc.
 * The upper bound can be calculated as follows: upperBound = lowerBound + width *
 * numberOfIntervals. The lower bound belongs to the first regular interval whereas the upper bound
 * is the first value which is associated with the upper outlier interval.
 *
 * The data structure is build up as follows for n=numberOfIntervals different requested measurement
 * intervals: First interval 'lower outlier interval': All measurements in the interval (-\infty,
 * lowerBound). Second to n-th interval 'regular interval i': All measurements in the interval
 * [lowerBound+width*(i-1), lowerBound+width*i). n-th interval 'upper outlier interval': All
 * measurements in the interval [lowerBound+width*n, \infty) = [upperBound+width*n, \infty).
 *
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * <ul>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.FixedIntervals#getLowerBound <em>
 * Lower Bound</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.FixedIntervals#getWidth <em>Width
 * </em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.FixedIntervals#getNumberOfIntervals
 ...
 * </p>
 *
 * @see org.palladiosimulator.edp2.models.ExperimentData.ExperimentDataPackage#getFixedIntervals()
 * @model
 * @generated
 */
public interface FixedIntervals extends Identifier {
     ...
     * <p>
     * If the meaning of the '<em>Lower Bound</em>' attribute isn't clear, there really should be
    ...
    /**
     * Returns the value of the '<em><b>Number Of Intervals</b></em>' attribute. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Number Of Intervals</em>' attribute isn't clear, there really
    ...
    /**
     * Returns the value of the '<em><b>Aggregated Measurements</b></em>' container reference. It is
     * bidirectional and its opposite is '
     * {@link org.palladiosimulator.edp2.models.ExperimentData.FixedWidthAggregatedMeasurements#getIntervals
     * <em>Intervals</em>}'. <!-- begin-user-doc -->
     * <p>
