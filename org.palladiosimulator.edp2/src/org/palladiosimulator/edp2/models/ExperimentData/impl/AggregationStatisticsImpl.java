 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.AggregationStatisticsImpl#getDistinctValuesBeforeAggregation <em>Distinct Values Before Aggregation</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.AggregationStatisticsImpl#getDistinctValuesAfterAggregation <em>Distinct Values After Aggregation</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.AggregationStatisticsImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AggregationStatisticsImpl extends IdentifierImpl implements
	 ...
	 */
	@Override
	public void setDistinctValuesBeforeAggregation(
			long newDistinctValuesBeforeAggregation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					oldDistinctValuesBeforeAggregation,
					distinctValuesBeforeAggregation));
	}
	 ...
	 */
	@Override
	public void setDistinctValuesAfterAggregation(
			long newDistinctValuesAfterAggregation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					oldDistinctValuesAfterAggregation,
					distinctValuesAfterAggregation));
	}
	...
	public AggregatedMeasurements getAggregatedMeasurements() {
		if (eContainerFeatureID() != ExperimentDataPackage.AGGREGATION_STATISTICS__AGGREGATED_MEASUREMENTS)
			return null;
	...
	public NotificationChain basicSetAggregatedMeasurements(
			AggregatedMeasurements newAggregatedMeasurements,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newAggregatedMeasurements,
	...
	public void setAggregatedMeasurements(
		...
		if (newAggregatedMeasurements != eInternalContainer()
				|| (eContainerFeatureID() != ExperimentDataPackage.AGGREGATION_STATISTICS__AGGREGATED_MEASUREMENTS && newAggregatedMeasurements != null)) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.AGGREGATION_STATISTICS__AGGREGATED_MEASUREMENTS:
			...
			return basicSetAggregatedMeasurements(
					(AggregatedMeasurements) otherEnd, msgs);
		}
