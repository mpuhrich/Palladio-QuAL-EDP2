 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DataSeriesImpl#getNumericalStatistics <em>Numerical Statistics</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DataSeriesImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DataSeriesImpl#getValuesUuid <em>Values Uuid</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DataSeriesImpl#getTextualStatistics <em>Textual Statistics</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DataSeriesImpl#getRawMeasurements <em>Raw Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DataSeriesImpl extends EObjectImpl implements DataSeries {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNumericalStatistics(
			NumericalNominalStatistics newNumericalStatistics,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldNumericalStatistics, newNumericalStatistics);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setNumericalStatistics(
		...
		if (newNumericalStatistics != numericalStatistics) {
			...
			if (newNumericalStatistics != null)
				msgs = ((InternalEObject) newNumericalStatistics)
						.eInverseAdd(
								this,
								ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__DATA_SERIES,
								NumericalNominalStatistics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.DATA_SERIES__NUMERICAL_STATISTICS,
					newNumericalStatistics, newNumericalStatistics));
	}
	...
	public FixedWidthAggregatedMeasurements getAggregatedMeasurements() {
		if (eContainerFeatureID() != ExperimentDataPackage.DATA_SERIES__AGGREGATED_MEASUREMENTS)
			return null;
	...
	public NotificationChain basicSetAggregatedMeasurements(
			FixedWidthAggregatedMeasurements newAggregatedMeasurements,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newAggregatedMeasurements,
	 ...
	 */
	@Override
	public void setAggregatedMeasurements(
			FixedWidthAggregatedMeasurements newAggregatedMeasurements) {
		if (newAggregatedMeasurements != eInternalContainer()
				|| (eContainerFeatureID() != ExperimentDataPackage.DATA_SERIES__AGGREGATED_MEASUREMENTS && newAggregatedMeasurements != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.DATA_SERIES__AGGREGATED_MEASUREMENTS,
					newAggregatedMeasurements, newAggregatedMeasurements));
	}
	...
	public void setValuesUuid(String newValuesUuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.DATA_SERIES__VALUES_UUID,
					oldValuesUuid, valuesUuid));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTextualStatistics(
			TextualNominalStatistics newTextualStatistics,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldTextualStatistics, newTextualStatistics);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 */
	@Override
	public void setTextualStatistics(
			TextualNominalStatistics newTextualStatistics) {
		if (newTextualStatistics != textualStatistics) {
			NotificationChain msgs = null;
			if (textualStatistics != null)
				msgs = ((InternalEObject) textualStatistics)
						.eInverseRemove(
								this,
								ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES,
								TextualNominalStatistics.class, msgs);
			if (newTextualStatistics != null)
				msgs = ((InternalEObject) newTextualStatistics)
						.eInverseAdd(
								this,
								ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES,
								TextualNominalStatistics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.DATA_SERIES__TEXTUAL_STATISTICS,
					newTextualStatistics, newTextualStatistics));
	}
	...
	public RawMeasurements getRawMeasurements() {
		if (eContainerFeatureID() != ExperimentDataPackage.DATA_SERIES__RAW_MEASUREMENTS)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRawMeasurements(
			RawMeasurements newRawMeasurements, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newRawMeasurements,
	...
	public void setRawMeasurements(RawMeasurements newRawMeasurements) {
		if (newRawMeasurements != eInternalContainer()
				|| (eContainerFeatureID() != ExperimentDataPackage.DATA_SERIES__RAW_MEASUREMENTS && newRawMeasurements != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					...
					newRawMeasurements, newRawMeasurements));
	}
				...
				msgs = ((InternalEObject) numericalStatistics)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- ExperimentDataPackage.DATA_SERIES__NUMERICAL_STATISTICS,
								null, msgs);
			return basicSetNumericalStatistics(
					(NumericalNominalStatistics) otherEnd, msgs);
		case ExperimentDataPackage.DATA_SERIES__AGGREGATED_MEASUREMENTS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetAggregatedMeasurements(
					(FixedWidthAggregatedMeasurements) otherEnd, msgs);
				...
				msgs = ((InternalEObject) textualStatistics)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- ExperimentDataPackage.DATA_SERIES__TEXTUAL_STATISTICS,
								null, msgs);
			return basicSetTextualStatistics(
					(TextualNominalStatistics) otherEnd, msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case ExperimentDataPackage.DATA_SERIES__VALUES_UUID:
			return VALUES_UUID_EDEFAULT == null ? valuesUuid != null
					: !VALUES_UUID_EDEFAULT.equals(valuesUuid);
		case ExperimentDataPackage.DATA_SERIES__TEXTUAL_STATISTICS:
