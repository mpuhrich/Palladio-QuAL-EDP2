 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.DoubleBinaryMeasurementsImpl#getStorageUnit <em>Storage Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DoubleBinaryMeasurementsImpl<Q extends Quantity> extends
		DataSeriesImpl implements DoubleBinaryMeasurements<Q> {
	/**
	...
	public void setStorageUnit(Unit<Q> newStorageUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.DOUBLE_BINARY_MEASUREMENTS__STORAGE_UNIT,
					oldStorageUnit, storageUnit));
	}
