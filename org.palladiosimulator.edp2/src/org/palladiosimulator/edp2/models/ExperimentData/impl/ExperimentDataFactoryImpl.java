...
public class ExperimentDataFactoryImpl extends EFactoryImpl implements
	...
	public Object createFromString(final EDataType eDataType,
		...
		case ExperimentDataPackage.EJS_DURATION_MEASURE:
			return this.createEJSDurationMeasureFromString(eDataType,
					initialValue);
		default:
	...
	public String convertToString(final EDataType eDataType,
		...
		case ExperimentDataPackage.EJS_DURATION_MEASURE:
			return this.convertEJSDurationMeasureToString(eDataType,
					instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '"
					+ eDataType.getName() + "' is not a valid classifier");
	...
	public javax.measure.Measure<?, ?> createEJSMeasureFromString(
		...
		return (javax.measure.Measure<?, ?>) this
				.readEJSMeasureObject(initialValue);
	}
	...
	public String convertEJSMeasureToString(final EDataType eDataType,
			final Object instanceValue) {
		return this
				.writeEJSMeasureObject((javax.measure.Measure) instanceValue);
	}

	private String writeEJSMeasureObject(javax.measure.Measure m) {
		if (m == null || m.getValue() == null) {
			return null;
		}
		StringBuilder sb = new StringBuilder(m.getValue().toString());
		if (m.getUnit() != null) {
			sb.append(" ");
			sb.append(m.getUnit().toString());
		}
		return sb.toString();
	}
	...
	private javax.measure.Measure readEJSMeasureObject(String initialValue) {
		...
		try {
			...
			if (items.length < 2) {
				return DecimalMeasure.valueOf(value, Dimensionless.UNIT);
			}
