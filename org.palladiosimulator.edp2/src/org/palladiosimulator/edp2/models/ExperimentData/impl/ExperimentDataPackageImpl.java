...
public class ExperimentDataPackageImpl extends EPackageImpl implements ExperimentDataPackage {
    ...
    public EClass getMeasurementsRange() {
        return this.measurementsRangeEClass;
    }
    ...
    public EReference getMeasurementsRange_RawMeasurements() {
        return (EReference) this.measurementsRangeEClass.getEStructuralFeatures().get(0);
    }
    ...
    public EAttribute getMeasurementsRange_EndTime() {
        return (EAttribute) this.measurementsRangeEClass.getEStructuralFeatures().get(2);
    }
    ...
    public EAttribute getMeasurementsRange_StartTime() {
        return (EAttribute) this.measurementsRangeEClass.getEStructuralFeatures().get(3);
    }
    ...
    public EReference getMeasurementsRange_Measurements() {
        return (EReference) this.measurementsRangeEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EReference getMeasurementsRange_AggregatedMeasurements() {
        return (EReference) this.measurementsRangeEClass.getEStructuralFeatures().get(4);
    }
    ...
    public EClass getMeasurements() {
        return this.measurementsEClass;
    }
    ...
    public EReference getMeasurements_Measure() {
        return (EReference) this.measurementsEClass.getEStructuralFeatures().get(0);
    }
    ...
    public EReference getMeasurements_MeasurementsRanges() {
        return (EReference) this.measurementsEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EReference getMeasurements_Run() {
        return (EReference) this.measurementsEClass.getEStructuralFeatures().get(2);
    }
    ...
    public void createPackageContents() {
        ...
        this.createEReference(this.aggregatedMeasurementsEClass, AGGREGATED_MEASUREMENTS__MEASUREMENTS_RANGE);
        ...
        this.measurementsRangeEClass = this.createEClass(MEASUREMENTS_RANGE);
        this.createEReference(this.measurementsRangeEClass, MEASUREMENTS_RANGE__RAW_MEASUREMENTS);
        this.createEReference(this.measurementsRangeEClass, MEASUREMENTS_RANGE__MEASUREMENTS);
        this.createEAttribute(this.measurementsRangeEClass, MEASUREMENTS_RANGE__END_TIME);
        this.createEAttribute(this.measurementsRangeEClass, MEASUREMENTS_RANGE__START_TIME);
        this.createEReference(this.measurementsRangeEClass, MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS);
        ...
        this.createEReference(this.rawMeasurementsEClass, RAW_MEASUREMENTS__MEASUREMENTS_RANGE);
        ...
        this.createEReference(this.experimentGroupEClass, EXPERIMENT_GROUP__MEASURE);
        ...
        this.createEReference(this.experimentSettingEClass, EXPERIMENT_SETTING__MEASURE);
        ...
        this.measurementsEClass = this.createEClass(MEASUREMENTS);
        this.createEReference(this.measurementsEClass, MEASUREMENTS__MEASURE);
        this.createEReference(this.measurementsEClass, MEASUREMENTS__MEASUREMENTS_RANGES);
        this.createEReference(this.measurementsEClass, MEASUREMENTS__RUN);

        this.measureEClass = this.createEClass(MEASURE);
        this.createEReference(this.measureEClass, MEASURE__EXPERIMENT_GROUP);
        this.createEReference(this.measureEClass, MEASURE__EXPERIMENT_SETTINGS);
        this.createEReference(this.measureEClass, MEASURE__METRIC);
        this.createEReference(this.measureEClass, MEASURE__MEASURING_POINT);
        ...
        this.createEReference(this.runEClass, RUN__MEASUREMENTS);
    ...
    public void initializePackageContents() {
        ...
        this.measurementsRangeEClass.getESuperTypes().add(this.getPropertyable());
        ...
        this.measurementsEClass.getESuperTypes().add(theIdentifierPackage.getIdentifier());
        this.measurementsEClass.getESuperTypes().add(this.getPropertyable());
        this.measureEClass.getESuperTypes().add(theIdentifierPackage.getIdentifier());
        ...
        this.initEReference(this.getAggregatedMeasurements_MeasurementsRange(), this.getMeasurementsRange(),
        ...
        this.initEClass(this.measurementsRangeEClass, MeasurementsRange.class, "MeasurementsRange", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        this.initEReference(this.getMeasurementsRange_RawMeasurements(), this.getRawMeasurements(),
                this.getRawMeasurements_MeasurementsRange(), "rawMeasurements", null, 0, 1, MeasurementsRange.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasurementsRange_Measurements(), this.getMeasurements(),
                this.getMeasurements_MeasurementsRanges(), "measurements", null, 1, 1, MeasurementsRange.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEAttribute(this.getMeasurementsRange_EndTime(), this.getEJSDurationMeasure(), "endTime", null, 1, 1,
                MeasurementsRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, !IS_ORDERED);
        this.initEAttribute(this.getMeasurementsRange_StartTime(), this.getEJSDurationMeasure(), "startTime", null, 1,
                1, MeasurementsRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasurementsRange_AggregatedMeasurements(), this.getAggregatedMeasurements(),
        ...
        this.initEReference(this.getRawMeasurements_DataSeries(), this.getDataSeries(),
                ...
                !IS_ORDERED);
        this.initEReference(this.getRawMeasurements_MeasurementsRange(), this.getMeasurementsRange(),
        ...
        this.initEReference(this.getExperimentGroup_ExperimentSettings(), this.getExperimentSetting(),
                ...
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getExperimentGroup_Measure(), this.getMeasure(), this.getMeasure_ExperimentGroup(),
                "measure", null, 0, -1, ExperimentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        ...
        this.initEReference(this.getExperimentSetting_ExperimentRuns(), this.getExperimentRun(),
                ...
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getExperimentSetting_Measure(), this.getMeasure(),
                this.getMeasure_ExperimentSettings(), "measure", null, 0, -1, ExperimentSetting.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        ...
        this.initEClass(this.measurementsEClass, Measurements.class, "Measurements", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        this.initEReference(this.getMeasurements_Measure(), this.getMeasure(), null, "measure", null, 1, 1,
                Measurements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasurements_MeasurementsRanges(), this.getMeasurementsRange(),
                this.getMeasurementsRange_Measurements(), "measurementsRanges", null, 0, -1, Measurements.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasurements_Run(), this.getRun(), this.getRun_Measurements(), "run", null, 1, 1,
                Measurements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        this.initEClass(this.measureEClass, org.palladiosimulator.edp2.models.ExperimentData.Measure.class, "Measure",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        this.initEReference(this.getMeasure_ExperimentGroup(), this.getExperimentGroup(),
                this.getExperimentGroup_Measure(), "experimentGroup", null, 1, 1,
                org.palladiosimulator.edp2.models.ExperimentData.Measure.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasure_ExperimentSettings(), this.getExperimentSetting(),
                this.getExperimentSetting_Measure(), "experimentSettings", null, 0, -1,
                org.palladiosimulator.edp2.models.ExperimentData.Measure.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getMeasure_Metric(), theMetricSpecPackage.getMetricDescription(), null, "metric",
                null, 1, 1, org.palladiosimulator.edp2.models.ExperimentData.Measure.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        this.initEReference(this.getMeasure_MeasuringPoint(), theMeasuringpointPackage.getMeasuringPoint(), null,
        ...
        this.initEAttribute(this.getRun_StartTime(), this.ecorePackage.getEDate(), "startTime", null, 1, 1, Run.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getRun_Measurements(), this.getMeasurements(), this.getMeasurements_Run(),
                "measurements", null, 0, -1, Run.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
