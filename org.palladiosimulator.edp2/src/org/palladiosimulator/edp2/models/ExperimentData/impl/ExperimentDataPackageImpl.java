 ...
 * @generated
 */
public class ExperimentDataPackageImpl extends EPackageImpl implements
	...
	public static ExperimentDataPackage init() {
		if (isInited)
			return (ExperimentDataPackage) EPackage.Registry.INSTANCE
		...
		ExperimentDataPackageImpl theExperimentDataPackage = (ExperimentDataPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ExperimentDataPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new ExperimentDataPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ExperimentDataPackage.eNS_URI,
	...
	public EReference getAggregatedMeasurements_MeasurementsRange() {
		return (EReference) aggregatedMeasurementsEClass
	...
	public EAttribute getAggregatedMeasurements_Valid() {
		return (EAttribute) aggregatedMeasurementsEClass
	...
	public EReference getMeasurementsRange_RawMeasurements() {
		return (EReference) measurementsRangeEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getMeasurementsRange_EndTime() {
		return (EAttribute) measurementsRangeEClass.getEStructuralFeatures()
				.get(2);
	}
	...
	public EAttribute getNumericalNominalStatistics_NumberMeasurements() {
		return (EAttribute) numericalNominalStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getNumericalNominalStatistics_NumericalMassDistribution() {
		return (EReference) numericalNominalStatisticsEClass
				.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getNumericalMassDistribution_Frequency() {
		return (EAttribute) numericalMassDistributionEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getNumericalMassDistribution_NumericalNominalStatistics() {
		return (EReference) numericalMassDistributionEClass
				.getEStructuralFeatures().get(2);
	}
	...
	public EReference getFixedWidthAggregatedMeasurements_Intervals() {
		return (EReference) fixedWidthAggregatedMeasurementsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getFixedIntervals_LowerBound() {
		return (EAttribute) fixedIntervalsEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getFixedIntervals_AggregatedMeasurements() {
		return (EReference) fixedIntervalsEClass.getEStructuralFeatures()
				.get(3);
	}
	...
	public EAttribute getTextualNominalStatistics_NumberMeasurements() {
		return (EAttribute) textualNominalStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getTextualNominalStatistics_MassDistribution() {
		return (EReference) textualNominalStatisticsEClass
				.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getTextualMassDistribution_Frequency() {
		return (EAttribute) textualMassDistributionEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getTextualMassDistribution_Identifier() {
		return (EReference) textualMassDistributionEClass
				.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getMeasurements_Run() {
	...
	public EAttribute getEStringtoEObjectMapEntry_Key() {
		return (EAttribute) eStringtoEObjectMapEntryEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getRawMeasurements_DataSeries() {
		return (EReference) rawMeasurementsEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EReference getExperimentGroup_ExperimentSettings() {
		return (EReference) experimentGroupEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getExperimentGroup_Purpose() {
		return (EAttribute) experimentGroupEClass.getEStructuralFeatures().get(
				2);
	}
	...
	public EAttribute getExperimentSetting_Description() {
		return (EAttribute) experimentSettingEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getExperimentSetting_ExperimentRuns() {
		return (EReference) experimentSettingEClass.getEStructuralFeatures()
				.get(1);
	}
	...
	public EAttribute getAggregationStatistics_DistinctValuesBeforeAggregation() {
		return (EAttribute) aggregationStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getAggregationStatistics_AggregatedMeasurements() {
		return (EReference) aggregationStatisticsEClass
				.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getLongBinaryMeasurements_StorageUnit() {
		return (EAttribute) longBinaryMeasurementsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getDoubleBinaryMeasurements_StorageUnit() {
		return (EAttribute) doubleBinaryMeasurementsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getNumericalIntervalStatistics_ArithmethicMean() {
		return (EAttribute) numericalIntervalStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getNumericalOrdinalStatistics_Minimum() {
		return (EAttribute) numericalOrdinalStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getNumericalOrdinalStatistics_Percentiles() {
		return (EReference) numericalOrdinalStatisticsEClass
				.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getNumericalPercentile_Percentile() {
		return (EAttribute) numericalPercentileEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getNumericalPercentile_OrdinalStatistics() {
		return (EReference) numericalPercentileEClass.getEStructuralFeatures()
				.get(2);
	}
	...
	public EReference getTextualOrdinalStatistics_Minimum() {
		return (EReference) textualOrdinalStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getExperimentGroupRun() {
		return experimentGroupRunEClass;
	}
	...
	public EReference getExperimentGroupRun_Experimentgroup() {
		return (EReference) experimentGroupRunEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getNumericalRatioStatistics_CoefficientOfVariation() {
		return (EAttribute) numericalRatioStatisticsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(aggregatedMeasurementsEClass,
				AGGREGATED_MEASUREMENTS__MEASUREMENTS_RANGE);
		createEAttribute(aggregatedMeasurementsEClass,
		...
		createEReference(measurementsRangeEClass,
				MEASUREMENTS_RANGE__RAW_MEASUREMENTS);
		createEReference(measurementsRangeEClass,
				MEASUREMENTS_RANGE__MEASUREMENTS);
		createEAttribute(measurementsRangeEClass, MEASUREMENTS_RANGE__END_TIME);
		createEAttribute(measurementsRangeEClass,
				MEASUREMENTS_RANGE__START_TIME);
		createEReference(measurementsRangeEClass,
				MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS);

		propertyableEClass = createEClass(PROPERTYABLE);
		createEReference(propertyableEClass,
				PROPERTYABLE__ADDITIONAL_INFORMATION);

		eStringtoEObjectMapEntryEClass = createEClass(ESTRINGTO_EOBJECT_MAP_ENTRY);
		createEAttribute(eStringtoEObjectMapEntryEClass,
		...
		createEReference(rawMeasurementsEClass,
				RAW_MEASUREMENTS__MEASUREMENTS_RANGE);
		...
		createEAttribute(numericalNominalStatisticsEClass,
				NUMERICAL_NOMINAL_STATISTICS__NUMBER_MEASUREMENTS);
		createEReference(numericalNominalStatisticsEClass,
		...
		createEAttribute(numericalMassDistributionEClass,
				NUMERICAL_MASS_DISTRIBUTION__FREQUENCY);
		createEAttribute(numericalMassDistributionEClass,
				NUMERICAL_MASS_DISTRIBUTION__VALUE);
		createEReference(numericalMassDistributionEClass,
		...
		createEReference(fixedWidthAggregatedMeasurementsEClass,
		...
		createEAttribute(textualMassDistributionEClass,
				TEXTUAL_MASS_DISTRIBUTION__FREQUENCY);
		createEReference(textualMassDistributionEClass,
		...
		createEReference(experimentGroupEClass,
		...
		createEReference(experimentGroupEClass, EXPERIMENT_GROUP__REPORTS);

		experimentSettingEClass = createEClass(EXPERIMENT_SETTING);
		createEAttribute(experimentSettingEClass,
				EXPERIMENT_SETTING__DESCRIPTION);
		createEReference(experimentSettingEClass,
		...
		createEReference(experimentRunEClass,
		...
		createEReference(measurementsEClass, MEASUREMENTS__RUN);
		...
		createEAttribute(longBinaryMeasurementsEClass,
		...
		createEAttribute(numericalRatioStatisticsEClass,
		...
		createEReference(textualOrdinalStatisticsEClass,
		...
		createEAttribute(runEClass, RUN__DURATION);
		createEAttribute(runEClass, RUN__START_TIME);
		createEReference(runEClass, RUN__MEASUREMENTS);

		experimentGroupRunEClass = createEClass(EXPERIMENT_GROUP_RUN);
		createEReference(experimentGroupRunEClass,
	...
	public void initializePackageContents() {
		...
		ETypeParameter doubleBinaryMeasurementsEClass_Q = addETypeParameter(
				doubleBinaryMeasurementsEClass, "Q");
		addETypeParameter(ejsMeasureEDataType, "V");
		ETypeParameter ejsMeasureEDataType_Q = addETypeParameter(
				ejsMeasureEDataType, "Q");

		// Set bounds for type parameters
		EGenericType g1 = createEGenericType(theMetricSpecPackage
				.getIJSQuantity());
		...
		aggregatedMeasurementsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		measurementsRangeEClass.getESuperTypes().add(this.getPropertyable());
		rawMeasurementsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		numericalNominalStatisticsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		fixedWidthAggregatedMeasurementsEClass.getESuperTypes().add(
				this.getAggregatedMeasurements());
		fixedIntervalsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		experimentGroupEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		experimentGroupEClass.getESuperTypes().add(this.getPropertyable());
		experimentSettingEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		experimentSettingEClass.getESuperTypes().add(this.getPropertyable());
		experimentRunEClass.getESuperTypes().add(this.getRun());
		measurementsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		measurementsEClass.getESuperTypes().add(this.getPropertyable());
		measureEClass.getESuperTypes()
				.add(theIdentifierPackage.getIdentifier());
		aggregationStatisticsEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		doubleBinaryMeasurementsEClass.getESuperTypes().add(
				this.getDataSeries());
		numericalIntervalStatisticsEClass.getESuperTypes().add(
				this.getNumericalOrdinalStatistics());
		numericalOrdinalStatisticsEClass.getESuperTypes().add(
				this.getNumericalNominalStatistics());
		numericalPercentileEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		...
		identifierBasedMeasurementsEClass.getESuperTypes().add(
				this.getDataSeries());
		numericalRatioStatisticsEClass.getESuperTypes().add(
				this.getNumericalIntervalStatistics());
		sensorFrameworkV1DoubleBinaryMeasurementsEClass.getESuperTypes().add(
				this.getDoubleBinaryMeasurements());
		sensorFrameworkV1IdentifierBasedMeasurementsEClass.getESuperTypes()
				.add(this.getIdentifierBasedMeasurements());
		textualOrdinalStatisticsEClass.getESuperTypes().add(
				this.getTextualNominalStatistics());
		runEClass.getESuperTypes().add(theIdentifierPackage.getIdentifier());
		runEClass.getESuperTypes().add(this.getPropertyable());
		experimentGroupRunEClass.getESuperTypes().add(this.getRun());

		// Initialize classes and features; add operations and parameters
		initEClass(aggregatedMeasurementsEClass, AggregatedMeasurements.class,
				"AggregatedMeasurements", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAggregatedMeasurements_MeasurementsRange(),
				this.getMeasurementsRange(),
				this.getMeasurementsRange_AggregatedMeasurements(),
				"measurementsRange", null, 1, 1, AggregatedMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getAggregatedMeasurements_Valid(),
				ecorePackage.getEBoolean(), "valid", null, 1, 1,
				AggregatedMeasurements.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getAggregatedMeasurements_Function(),
				theMetricSpecPackage.getAggregationFunctionDescription(), null,
				"function", null, 1, 1, AggregatedMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getAggregatedMeasurements_AggregationStatistics(),
				this.getAggregationStatistics(),
				this.getAggregationStatistics_AggregatedMeasurements(),
				"aggregationStatistics", null, 0, 1,
				AggregatedMeasurements.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAggregatedMeasurements_AggregationOn(),
				theMetricSpecPackage.getBaseMetricDescription(), null,
				"aggregationOn", null, 1, 1, AggregatedMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getAggregatedMeasurements_Metric(),
				theMetricSpecPackage.getMetricDescription(), null, "metric",
				null, 1, 1, AggregatedMeasurements.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(measurementsRangeEClass, MeasurementsRange.class,
				"MeasurementsRange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMeasurementsRange_RawMeasurements(),
				this.getRawMeasurements(),
				this.getRawMeasurements_MeasurementsRange(), "rawMeasurements",
				null, 0, 1, MeasurementsRange.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMeasurementsRange_Measurements(),
				this.getMeasurements(),
				this.getMeasurements_MeasurementsRanges(), "measurements",
				null, 1, 1, MeasurementsRange.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getMeasurementsRange_EndTime(),
				this.getEJSDurationMeasure(), "endTime", null, 1, 1,
				MeasurementsRange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getMeasurementsRange_StartTime(),
				this.getEJSDurationMeasure(), "startTime", null, 1, 1,
				MeasurementsRange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getMeasurementsRange_AggregatedMeasurements(),
				this.getAggregatedMeasurements(),
				this.getAggregatedMeasurements_MeasurementsRange(),
				"aggregatedMeasurements", null, 0, -1, MeasurementsRange.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(propertyableEClass, Propertyable.class, "Propertyable",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPropertyable_AdditionalInformation(),
				this.getEStringtoEObjectMapEntry(), null,
				"additionalInformation", null, 0, -1, Propertyable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(eStringtoEObjectMapEntryEClass, Map.Entry.class,
				"EStringtoEObjectMapEntry", !IS_ABSTRACT, !IS_INTERFACE,
				!IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEStringtoEObjectMapEntry_Key(),
				ecorePackage.getEString(), "key", null, 1, 1, Map.Entry.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getEStringtoEObjectMapEntry_Value(),
				ecorePackage.getEJavaObject(), "value", null, 1, 1,
				Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(rawMeasurementsEClass, RawMeasurements.class,
				"RawMeasurements", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRawMeasurements_DataSeries(), this.getDataSeries(),
				this.getDataSeries_RawMeasurements(), "dataSeries", null, 1,
				-1, RawMeasurements.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRawMeasurements_MeasurementsRange(),
				this.getMeasurementsRange(),
				this.getMeasurementsRange_RawMeasurements(),
				"measurementsRange", null, 1, 1, RawMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(dataSeriesEClass, DataSeries.class, "DataSeries",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataSeries_NumericalStatistics(),
				this.getNumericalNominalStatistics(),
				this.getNumericalNominalStatistics_DataSeries(),
				"numericalStatistics", null, 0, 1, DataSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getDataSeries_AggregatedMeasurements(),
				this.getFixedWidthAggregatedMeasurements(),
				this.getFixedWidthAggregatedMeasurements_DataSeries(),
				"aggregatedMeasurements", null, 0, 1, DataSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getDataSeries_ValuesUuid(), ecorePackage.getEString(),
				"valuesUuid", null, 1, 1, DataSeries.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getDataSeries_TextualStatistics(),
				this.getTextualNominalStatistics(),
				this.getTextualNominalStatistics_DataSeries(),
				"textualStatistics", null, 0, 1, DataSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getDataSeries_RawMeasurements(),
				this.getRawMeasurements(),
				this.getRawMeasurements_DataSeries(), "rawMeasurements", null,
				0, 1, DataSeries.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(numericalNominalStatisticsEClass,
				NumericalNominalStatistics.class, "NumericalNominalStatistics",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalNominalStatistics_NumberMeasurements(),
				this.getEJSMeasure(), "numberMeasurements", null, 1, 1,
				NumericalNominalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(
				getNumericalNominalStatistics_NumericalMassDistribution(),
				this.getNumericalMassDistribution(),
				this.getNumericalMassDistribution_NumericalNominalStatistics(),
				"numericalMassDistribution", null, 0, -1,
				NumericalNominalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getNumericalNominalStatistics_DataSeries(),
				this.getDataSeries(), this.getDataSeries_NumericalStatistics(),
				"dataSeries", null, 1, 1, NumericalNominalStatistics.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(numericalMassDistributionEClass,
				NumericalMassDistribution.class, "NumericalMassDistribution",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalMassDistribution_Frequency(),
				ecorePackage.getELong(), "frequency", null, 1, 1,
				NumericalMassDistribution.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalMassDistribution_Value(),
				this.getEJSMeasure(), "value", null, 1, 1,
				NumericalMassDistribution.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(
				...
				this.getNumericalNominalStatistics(),
				this.getNumericalNominalStatistics_NumericalMassDistribution(),
				"numericalNominalStatistics", null, 1, 1,
				NumericalMassDistribution.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(fixedWidthAggregatedMeasurementsEClass,
				FixedWidthAggregatedMeasurements.class,
				"FixedWidthAggregatedMeasurements", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFixedWidthAggregatedMeasurements_Intervals(),
				this.getFixedIntervals(),
				this.getFixedIntervals_AggregatedMeasurements(), "intervals",
				null, 1, 1, FixedWidthAggregatedMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getFixedWidthAggregatedMeasurements_DataSeries(),
				this.getDataSeries(),
				this.getDataSeries_AggregatedMeasurements(), "dataSeries",
				null, 1, -1, FixedWidthAggregatedMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(fixedIntervalsEClass, FixedIntervals.class,
				"FixedIntervals", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFixedIntervals_LowerBound(), this.getEJSMeasure(),
				"lowerBound", null, 1, 1, FixedIntervals.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getFixedIntervals_Width(), this.getEJSMeasure(),
				"width", null, 1, 1, FixedIntervals.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getFixedIntervals_NumberOfIntervals(),
				ecorePackage.getELong(), "numberOfIntervals", null, 1, 1,
				FixedIntervals.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getFixedIntervals_AggregatedMeasurements(),
				this.getFixedWidthAggregatedMeasurements(),
				this.getFixedWidthAggregatedMeasurements_Intervals(),
				"aggregatedMeasurements", null, 1, 1, FixedIntervals.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(textualNominalStatisticsEClass,
				TextualNominalStatistics.class, "TextualNominalStatistics",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTextualNominalStatistics_NumberMeasurements(),
				ecorePackage.getELong(), "numberMeasurements", null, 1, 1,
				TextualNominalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getTextualNominalStatistics_MassDistribution(),
				this.getTextualMassDistribution(),
				this.getTextualMassDistribution_TextualNominalStatistics(),
				"massDistribution", null, 0, -1,
				TextualNominalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTextualNominalStatistics_DataSeries(),
				this.getDataSeries(), this.getDataSeries_TextualStatistics(),
				"dataSeries", null, 1, 1, TextualNominalStatistics.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(textualMassDistributionEClass,
				TextualMassDistribution.class, "TextualMassDistribution",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTextualMassDistribution_Frequency(),
				ecorePackage.getELong(), "frequency", null, 1, 1,
				TextualMassDistribution.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getTextualMassDistribution_Identifier(),
				theMetricSpecPackage.getIdentifier(), null, "identifier", null,
				1, 1, TextualMassDistribution.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTextualMassDistribution_TextualNominalStatistics(),
				this.getTextualNominalStatistics(),
				this.getTextualNominalStatistics_MassDistribution(),
				"textualNominalStatistics", null, 1, 1,
				TextualMassDistribution.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(experimentGroupEClass, ExperimentGroup.class,
				"ExperimentGroup", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExperimentGroup_ExperimentSettings(),
				this.getExperimentSetting(),
				this.getExperimentSetting_ExperimentGroup(),
				"experimentSettings", null, 0, -1, ExperimentGroup.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getExperimentGroup_Measure(), this.getMeasure(),
				this.getMeasure_ExperimentGroup(), "measure", null, 0, -1,
				ExperimentGroup.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getExperimentGroup_Purpose(), ecorePackage.getEString(),
				"purpose", null, 1, 1, ExperimentGroup.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getExperimentGroup_Repository(),
				theRepositoryPackage.getRepository(),
				theRepositoryPackage.getRepository_ExperimentGroups(),
				"repository", null, 0, 1, ExperimentGroup.class, IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getExperimentGroup_Reports(),
				this.getExperimentGroupRun(),
				this.getExperimentGroupRun_Experimentgroup(), "reports", null,
				0, -1, ExperimentGroup.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(experimentSettingEClass, ExperimentSetting.class,
				"ExperimentSetting", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExperimentSetting_Description(),
				ecorePackage.getEString(), "description", null, 1, 1,
				ExperimentSetting.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getExperimentSetting_ExperimentRuns(),
				this.getExperimentRun(),
				this.getExperimentRun_ExperimentSetting(), "experimentRuns",
				null, 0, -1, ExperimentSetting.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getExperimentSetting_Measure(), this.getMeasure(),
				this.getMeasure_ExperimentSettings(), "measure", null, 0, -1,
				ExperimentSetting.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getExperimentSetting_ExperimentGroup(),
				this.getExperimentGroup(),
				this.getExperimentGroup_ExperimentSettings(),
				"experimentGroup", null, 1, 1, ExperimentSetting.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(experimentRunEClass, ExperimentRun.class, "ExperimentRun",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExperimentRun_ExperimentSetting(),
				this.getExperimentSetting(),
				this.getExperimentSetting_ExperimentRuns(),
				"experimentSetting", null, 1, 1, ExperimentRun.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(measurementsEClass, Measurements.class, "Measurements",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMeasurements_Measure(), this.getMeasure(), null,
				"measure", null, 1, 1, Measurements.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMeasurements_MeasurementsRanges(),
				this.getMeasurementsRange(),
				this.getMeasurementsRange_Measurements(), "measurementsRanges",
				null, 0, -1, Measurements.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMeasurements_Run(), this.getRun(),
				this.getRun_Measurements(), "run", null, 1, 1,
				Measurements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(measureEClass,
				org.palladiosimulator.edp2.models.ExperimentData.Measure.class,
				"Measure", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMeasure_ExperimentGroup(), this.getExperimentGroup(),
				this.getExperimentGroup_Measure(), "experimentGroup", null, 1,
				1,
				org.palladiosimulator.edp2.models.ExperimentData.Measure.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getMeasure_ExperimentSettings(),
				this.getExperimentSetting(),
				this.getExperimentSetting_Measure(), "experimentSettings",
				null, 0, -1,
				org.palladiosimulator.edp2.models.ExperimentData.Measure.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getMeasure_Metric(),
				theMetricSpecPackage.getMetricDescription(), null, "metric",
				null, 1, 1,
				org.palladiosimulator.edp2.models.ExperimentData.Measure.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getMeasure_MeasuringPoint(),
				theMeasuringpointPackage.getMeasuringPoint(), null,
				"measuringPoint", null, 1, 1,
				org.palladiosimulator.edp2.models.ExperimentData.Measure.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(aggregationStatisticsEClass, AggregationStatistics.class,
				"AggregationStatistics", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(
				getAggregationStatistics_DistinctValuesBeforeAggregation(),
				ecorePackage.getELong(), "distinctValuesBeforeAggregation",
				null, 1, 1, AggregationStatistics.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
				getAggregationStatistics_DistinctValuesAfterAggregation(),
				ecorePackage.getELong(), "distinctValuesAfterAggregation",
				null, 1, 1, AggregationStatistics.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getAggregationStatistics_AggregatedMeasurements(),
				this.getAggregatedMeasurements(),
				this.getAggregatedMeasurements_AggregationStatistics(),
				"aggregatedMeasurements", null, 1, 1,
				AggregationStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(doubleBinaryMeasurementsEClass,
				DoubleBinaryMeasurements.class, "DoubleBinaryMeasurements",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getDoubleBinaryMeasurements_StorageUnit(), g1,
				"storageUnit", null, 1, 1, DoubleBinaryMeasurements.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(numericalIntervalStatisticsEClass,
				NumericalIntervalStatistics.class,
				"NumericalIntervalStatistics", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalIntervalStatistics_ArithmethicMean(),
				this.getEJSMeasure(), "arithmethicMean", null, 1, 1,
				NumericalIntervalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalIntervalStatistics_Variance(),
				this.getEJSMeasure(), "variance", null, 1, 1,
				NumericalIntervalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalIntervalStatistics_StandardDeviation(),
				this.getEJSMeasure(), "standardDeviation", null, 1, 1,
				NumericalIntervalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalIntervalStatistics_Sum(),
				this.getEJSMeasure(), "sum", null, 1, 1,
				NumericalIntervalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(numericalOrdinalStatisticsEClass,
				NumericalOrdinalStatistics.class, "NumericalOrdinalStatistics",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalOrdinalStatistics_Minimum(),
				this.getEJSMeasure(), "minimum", null, 1, 1,
				NumericalOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalOrdinalStatistics_Maximum(),
				this.getEJSMeasure(), "maximum", null, 1, 1,
				NumericalOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalOrdinalStatistics_Median(),
				this.getEJSMeasure(), "median", null, 0, 1,
				NumericalOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getNumericalOrdinalStatistics_Percentiles(),
				this.getNumericalPercentile(),
				this.getNumericalPercentile_OrdinalStatistics(), "percentiles",
				null, 0, -1, NumericalOrdinalStatistics.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(numericalPercentileEClass, NumericalPercentile.class,
				"NumericalPercentile", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalPercentile_Percentile(),
				ecorePackage.getEDouble(), "percentile", null, 1, 1,
				NumericalPercentile.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalPercentile_Value(), this.getEJSMeasure(),
				"value", null, 1, 1, NumericalPercentile.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getNumericalPercentile_OrdinalStatistics(),
				this.getNumericalOrdinalStatistics(),
				this.getNumericalOrdinalStatistics_Percentiles(),
				"ordinalStatistics", null, 1, 1, NumericalPercentile.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(jsXmlMeasurementsEClass, JSXmlMeasurements.class,
				"JSXmlMeasurements", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(longBinaryMeasurementsEClass, LongBinaryMeasurements.class,
				"LongBinaryMeasurements", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLongBinaryMeasurements_StorageUnit(),
				theMetricSpecPackage.getEJSUnit(), "storageUnit", null, 1, 1,
				LongBinaryMeasurements.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(identifierBasedMeasurementsEClass,
				IdentifierBasedMeasurements.class,
				"IdentifierBasedMeasurements", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(numericalRatioStatisticsEClass,
				NumericalRatioStatistics.class, "NumericalRatioStatistics",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumericalRatioStatistics_CoefficientOfVariation(),
				this.getEJSMeasure(), "coefficientOfVariation", null, 1, 1,
				NumericalRatioStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalRatioStatistics_GeometricMean(),
				this.getEJSMeasure(), "geometricMean", null, 1, 1,
				NumericalRatioStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getNumericalRatioStatistics_HarmonicMean(),
				this.getEJSMeasure(), "harmonicMean", null, 1, 1,
				NumericalRatioStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(sensorFrameworkV1DoubleBinaryMeasurementsEClass,
				SensorFrameworkV1DoubleBinaryMeasurements.class,
				"SensorFrameworkV1DoubleBinaryMeasurements", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(sensorFrameworkV1IdentifierBasedMeasurementsEClass,
				SensorFrameworkV1IdentifierBasedMeasurements.class,
				"SensorFrameworkV1IdentifierBasedMeasurements", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(ijsDurationEClass, Duration.class, "IJSDuration",
				IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);

		initEClass(eComparableEClass, Comparable.class, "EComparable",
				IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);

		initEClass(textualOrdinalStatisticsEClass,
				TextualOrdinalStatistics.class, "TextualOrdinalStatistics",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTextualOrdinalStatistics_Minimum(),
				theMetricSpecPackage.getIdentifier(), null, "minimum", null, 1,
				1, TextualOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTextualOrdinalStatistics_Maximum(),
				theMetricSpecPackage.getIdentifier(), null, "maximum", null, 1,
				1, TextualOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTextualOrdinalStatistics_Median(),
				theMetricSpecPackage.getIdentifier(), null, "median", null, 1,
				1, TextualOrdinalStatistics.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(runEClass, Run.class, "Run", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRun_Duration(), this.getEJSDurationMeasure(),
				"duration", null, 1, 1, Run.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getRun_StartTime(), ecorePackage.getEDate(),
				"startTime", null, 1, 1, Run.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getRun_Measurements(), this.getMeasurements(),
				this.getMeasurements_Run(), "measurements", null, 0, -1,
				Run.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(experimentGroupRunEClass, ExperimentGroupRun.class,
				"ExperimentGroupRun", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExperimentGroupRun_Experimentgroup(),
				this.getExperimentGroup(), this.getExperimentGroup_Reports(),
				"experimentgroup", null, 1, 1, ExperimentGroupRun.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		// Initialize data types
		initEDataType(ejsMeasureEDataType, Measure.class, "EJSMeasure",
				IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(ejsDurationMeasureEDataType, Measure.class,
				"EJSDurationMeasure", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
