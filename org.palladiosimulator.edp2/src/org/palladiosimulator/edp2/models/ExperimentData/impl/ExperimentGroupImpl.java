 ...
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getMeasure
 * <em>Measure</em>}</li>
...
public class ExperimentGroupImpl extends IdentifierImpl implements ExperimentGroup {
    ...
    public EList<ExperimentSetting> getExperimentSettings() {
        if (experimentSettings == null) {
            experimentSettings = new EObjectContainmentWithInverseEList<ExperimentSetting>(ExperimentSetting.class,
                    this, ExperimentDataPackage.EXPERIMENT_GROUP__EXPERIMENT_SETTINGS,
            ...
            if (repository != oldRepository) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ExperimentDataPackage.EXPERIMENT_GROUP__REPOSITORY, oldRepository, repository));
            }
        }
        return repository;
    }
    ...
    public void setRepository(Repository newRepository) {
        if (newRepository != repository) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.EXPERIMENT_GROUP__REPOSITORY,
    ...
    public void setPurpose(String newPurpose) {
        ...
        purpose = newPurpose;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.EXPERIMENT_GROUP__PURPOSE,
                    oldPurpose, purpose));
    }
    ...
    public EList<Measure> getMeasure() {
        if (measure == null) {
            measure = new EObjectContainmentWithInverseEList<Measure>(Measure.class, this,
                    ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE, ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP);
        }
        return measure;
    }
