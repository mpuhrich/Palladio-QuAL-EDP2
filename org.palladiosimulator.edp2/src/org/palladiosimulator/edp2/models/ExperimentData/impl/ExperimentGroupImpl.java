 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getAdditionalInformation <em>Additional Information</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getExperimentSettings <em>Experiment Settings</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentGroupImpl#getReports <em>Reports</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExperimentGroupImpl extends IdentifierImpl implements
		ExperimentGroup {
	/**
	...
	public EMap<String, Object> getAdditionalInformation() {
		if (additionalInformation == null) {
			additionalInformation = new EcoreEMap<String, Object>(
					...
					EStringtoEObjectMapEntryImpl.class,
					this,
					ExperimentDataPackage.EXPERIMENT_GROUP__ADDITIONAL_INFORMATION);
		}
	...
	public EList<ExperimentSetting> getExperimentSettings() {
		if (experimentSettings == null) {
			experimentSettings = new EObjectContainmentWithInverseEList<ExperimentSetting>(
					ExperimentSetting.class,
					this,
					ExperimentDataPackage.EXPERIMENT_GROUP__EXPERIMENT_SETTINGS,
	...
	public EList<ExperimentGroupRun> getReports() {
		if (reports == null) {
			reports = new EObjectContainmentWithInverseEList<ExperimentGroupRun>(
					ExperimentGroupRun.class, this,
	...
	public void setPurpose(String newPurpose) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.EXPERIMENT_GROUP__PURPOSE,
					oldPurpose, purpose));
	}
	...
	public EList<Measure> getMeasure() {
		if (measure == null) {
			measure = new EObjectContainmentWithInverseEList<Measure>(
					Measure.class, this,
					ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE,
					ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP);
		}
		return measure;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.EXPERIMENT_GROUP__EXPERIMENT_SETTINGS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getExperimentSettings())
					.basicAdd(otherEnd, msgs);
		case ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getMeasure())
					.basicAdd(otherEnd, msgs);
		...
		case ExperimentDataPackage.EXPERIMENT_GROUP__REPORTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getReports())
					.basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.EXPERIMENT_GROUP__ADDITIONAL_INFORMATION:
			return ((InternalEList<?>) getAdditionalInformation()).basicRemove(
					otherEnd, msgs);
		case ExperimentDataPackage.EXPERIMENT_GROUP__EXPERIMENT_SETTINGS:
			return ((InternalEList<?>) getExperimentSettings()).basicRemove(
					otherEnd, msgs);
		case ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE:
			return ((InternalEList<?>) getMeasure())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExperimentDataPackage.EXPERIMENT_GROUP__EXPERIMENT_SETTINGS:
			...
			getExperimentSettings().addAll(
					(Collection<? extends ExperimentSetting>) newValue);
			return;
		case ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE:
			getMeasure().clear();
		...
		case ExperimentDataPackage.EXPERIMENT_GROUP__REPORTS:
			getReports().clear();
			getReports().addAll(
					(Collection<? extends ExperimentGroupRun>) newValue);
			return;
		}
