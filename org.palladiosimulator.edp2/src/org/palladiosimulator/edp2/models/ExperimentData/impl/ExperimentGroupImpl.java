...
public class ExperimentGroupImpl extends IdentifierImpl implements ExperimentGroup {
	...
	public EList<Measure> getMeasure() {
        if (measure == null) {
            measure = new EObjectContainmentWithInverseEList<Measure>(Measure.class, this, ExperimentDataPackage.EXPERIMENT_GROUP__MEASURE, ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP);
        }
        return measure;
    }
