 ...
 * <ul>
 * <li>
 * {@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentRunImpl#getAdditionalInformation
 * <em>Additional Information</em>}</li>
 * <li>
 * {@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentRunImpl#getMeasurements
 * <em>Measurements</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentRunImpl#getStartTime
 * <em>Start Time</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.ExperimentRunImpl#getDuration
 * <em>Duration</em>}</li>
 * <li>
 ...
 * @generated
 */
public class ExperimentRunImpl extends IdentifierImpl implements ExperimentRun {
    /**
    ...
    public EMap<String, Object> getAdditionalInformation() {
        if (additionalInformation == null) {
            additionalInformation = new EcoreEMap<String, Object>(
                    ...
                    this, ExperimentDataPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION);
        }
    ...
    public EList<Measurements> getMeasurements() {
        if (measurements == null) {
            measurements = new EObjectContainmentWithInverseEList<Measurements>(Measurements.class, this,
                    ExperimentDataPackage.EXPERIMENT_RUN__MEASUREMENTS,
                    ExperimentDataPackage.MEASUREMENTS__EXPERIMENT_RUN);
        }
        return measurements;
    }
    ...
    public void setStartTime(Date newStartTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.EXPERIMENT_RUN__START_TIME,
    ...
    public void setDuration(Measure newDuration) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.EXPERIMENT_RUN__DURATION,
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case ExperimentDataPackage.EXPERIMENT_RUN__EXPERIMENT_SETTING:
            return eInternalContainer().eInverseRemove(this, ExperimentDataPackage.EXPERIMENT_SETTING__EXPERIMENT_RUNS,
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Propertyable.class) {
            ...
            case ExperimentDataPackage.PROPERTYABLE__ADDITIONAL_INFORMATION:
                return ExperimentDataPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION;
            default:
                return -1;
            }
        }
