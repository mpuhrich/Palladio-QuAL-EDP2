...
public class ExperimentSettingImpl extends IdentifierImpl implements ExperimentSetting {
	...
	public EList<Measure> getMeasure() {
        if (measure == null) {
            measure = new EObjectWithInverseResolvingEList.ManyInverse<Measure>(Measure.class, this, ExperimentDataPackage.EXPERIMENT_SETTING__MEASURE, ExperimentDataPackage.MEASURE__EXPERIMENT_SETTINGS);
        }
        return measure;
    }
