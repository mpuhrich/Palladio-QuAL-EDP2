 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.FixedWidthAggregatedMeasurementsImpl#getIntervals <em>Intervals</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.FixedWidthAggregatedMeasurementsImpl#getDataSeries <em>Data Series</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FixedWidthAggregatedMeasurementsImpl extends
		AggregatedMeasurementsImpl implements FixedWidthAggregatedMeasurements {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIntervals(FixedIntervals newIntervals,
	...
	public void setIntervals(FixedIntervals newIntervals) {
		if (newIntervals != intervals) {
			...
			if (intervals != null)
				msgs = ((InternalEObject) intervals)
						.eInverseRemove(
								this,
								ExperimentDataPackage.FIXED_INTERVALS__AGGREGATED_MEASUREMENTS,
								FixedIntervals.class, msgs);
			if (newIntervals != null)
				msgs = ((InternalEObject) newIntervals)
						.eInverseAdd(
								this,
								ExperimentDataPackage.FIXED_INTERVALS__AGGREGATED_MEASUREMENTS,
								FixedIntervals.class, msgs);
	...
	public EList<DataSeries> getDataSeries() {
		if (dataSeries == null) {
			dataSeries = new EObjectContainmentWithInverseEList<DataSeries>(
					DataSeries.class,
					this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.FIXED_WIDTH_AGGREGATED_MEASUREMENTS__DATA_SERIES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDataSeries())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.FIXED_WIDTH_AGGREGATED_MEASUREMENTS__DATA_SERIES:
			return ((InternalEList<?>) getDataSeries()).basicRemove(otherEnd,
					msgs);
		}
