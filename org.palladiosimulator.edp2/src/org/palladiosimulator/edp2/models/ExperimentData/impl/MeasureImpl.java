...
public class MeasureImpl extends IdentifierImpl implements Measure {
			...
			if (metric != oldMetric) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExperimentDataPackage.MEASURE__METRIC, oldMetric,
							metric));
			}
		}
		return metric;
	...
	public void setMetric(MetricDescription newMetric) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.MEASURE__METRIC, oldMetric, metric));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMeasuringPoint(
			MeasuringPoint newMeasuringPoint, NotificationChain msgs) {
		MeasuringPoint oldMeasuringPoint = measuringPoint;
		measuringPoint = newMeasuringPoint;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ExperimentDataPackage.MEASURE__MEASURING_POINT,
					oldMeasuringPoint, newMeasuringPoint);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMeasuringPoint(MeasuringPoint newMeasuringPoint) {
		if (newMeasuringPoint != measuringPoint) {
			...
			if (measuringPoint != null)
				msgs = ((InternalEObject) measuringPoint)
						.eInverseRemove(
								this,
			...
			if (newMeasuringPoint != null)
				msgs = ((InternalEObject) newMeasuringPoint)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- ExperimentDataPackage.MEASURE__MEASURING_POINT,
