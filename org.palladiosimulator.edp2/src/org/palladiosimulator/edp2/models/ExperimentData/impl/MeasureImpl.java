 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasureImpl#getExperimentGroup <em>Experiment Group</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasureImpl#getExperimentSettings <em>Experiment Settings</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasureImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasureImpl#getMeasuringPoint <em>Measuring Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasureImpl extends IdentifierImpl implements Measure {
    ...
    public ExperimentGroup getExperimentGroup() {
        if (eContainerFeatureID() != ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP) return null;
    ...
    public NotificationChain basicSetExperimentGroup(ExperimentGroup newExperimentGroup, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newExperimentGroup, ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP, msgs);
        return msgs;
    }
    ...
    public void setExperimentGroup(ExperimentGroup newExperimentGroup) {
        if (newExperimentGroup != eInternalContainer() || (eContainerFeatureID() != ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP && newExperimentGroup != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.MEASURE__EXPERIMENT_GROUP, newExperimentGroup, newExperimentGroup));
    }
    ...
    public EList<ExperimentSetting> getExperimentSettings() {
        if (experimentSettings == null) {
            experimentSettings = new EObjectWithInverseResolvingEList.ManyInverse<ExperimentSetting>(ExperimentSetting.class, this, ExperimentDataPackage.MEASURE__EXPERIMENT_SETTINGS, ExperimentDataPackage.EXPERIMENT_SETTING__MEASURE);
        }
        ...
        if (metric != null && metric.eIsProxy()) {
            ...
            if (metric != oldMetric) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExperimentDataPackage.MEASURE__METRIC, oldMetric, metric));
            }
        }
        return metric;
    }
    ...
    public void setMetric(MetricDescription newMetric) {
        ...
        metric = newMetric;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.MEASURE__METRIC, oldMetric, metric));
    }
    ...
    public NotificationChain basicSetMeasuringPoint(MeasuringPoint newMeasuringPoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.MEASURE__MEASURING_POINT, oldMeasuringPoint, newMeasuringPoint);
    ...
    public void setMeasuringPoint(MeasuringPoint newMeasuringPoint) {
        if (newMeasuringPoint != measuringPoint) {
            ...
            if (measuringPoint != null)
                msgs = ((InternalEObject)measuringPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExperimentDataPackage.MEASURE__MEASURING_POINT, null, msgs);
            if (newMeasuringPoint != null)
                msgs = ((InternalEObject)newMeasuringPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExperimentDataPackage.MEASURE__MEASURING_POINT, null, msgs);
            msgs = basicSetMeasuringPoint(newMeasuringPoint, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExperimentDataPackage.MEASURE__MEASURING_POINT, newMeasuringPoint, newMeasuringPoint));
    }
