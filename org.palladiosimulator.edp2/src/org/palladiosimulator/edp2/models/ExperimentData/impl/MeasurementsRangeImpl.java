 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasurementsRangeImpl#getRawMeasurements <em>Raw Measurements</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasurementsRangeImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasurementsRangeImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasurementsRangeImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.MeasurementsRangeImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MeasurementsRangeImpl extends PropertyableImpl implements
		MeasurementsRange {
	/**
	...
	public NotificationChain basicSetRawMeasurements(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ExperimentDataPackage.MEASUREMENTS_RANGE__RAW_MEASUREMENTS,
					oldRawMeasurements, newRawMeasurements);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRawMeasurements(RawMeasurements newRawMeasurements) {
		if (newRawMeasurements != rawMeasurements) {
			...
			if (rawMeasurements != null)
				msgs = ((InternalEObject) rawMeasurements)
						.eInverseRemove(
								this,
								ExperimentDataPackage.RAW_MEASUREMENTS__MEASUREMENTS_RANGE,
								RawMeasurements.class, msgs);
			if (newRawMeasurements != null)
				msgs = ((InternalEObject) newRawMeasurements)
						.eInverseAdd(
								this,
								ExperimentDataPackage.RAW_MEASUREMENTS__MEASUREMENTS_RANGE,
								RawMeasurements.class, msgs);
	...
	public void setEndTime(Measure newEndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.MEASUREMENTS_RANGE__END_TIME,
					oldEndTime, endTime));
	}
	...
	public void setStartTime(Measure newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.MEASUREMENTS_RANGE__START_TIME,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMeasurements(Measurements newMeasurements,
	...
	public void setMeasurements(Measurements newMeasurements) {
		if (newMeasurements != eInternalContainer()
			...
			if (newMeasurements != null)
				msgs = ((InternalEObject) newMeasurements)
						.eInverseAdd(
								this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getAggregatedMeasurements())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS:
			return ((InternalEList<?>) getAggregatedMeasurements())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExperimentDataPackage.MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS:
			...
			getAggregatedMeasurements().addAll(
					(Collection<? extends AggregatedMeasurements>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ExperimentDataPackage.MEASUREMENTS_RANGE__END_TIME:
			return END_TIME_EDEFAULT == null ? endTime != null
					: !END_TIME_EDEFAULT.equals(endTime);
		case ExperimentDataPackage.MEASUREMENTS_RANGE__START_TIME:
			return START_TIME_EDEFAULT == null ? startTime != null
					: !START_TIME_EDEFAULT.equals(startTime);
		case ExperimentDataPackage.MEASUREMENTS_RANGE__AGGREGATED_MEASUREMENTS:
			return aggregatedMeasurements != null
					&& !aggregatedMeasurements.isEmpty();
		}
