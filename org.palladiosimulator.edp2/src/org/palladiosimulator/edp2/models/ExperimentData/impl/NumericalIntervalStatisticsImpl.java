 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalIntervalStatisticsImpl#getArithmethicMean <em>Arithmethic Mean</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalIntervalStatisticsImpl#getVariance <em>Variance</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalIntervalStatisticsImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalIntervalStatisticsImpl#getSum <em>Sum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NumericalIntervalStatisticsImpl extends
		NumericalOrdinalStatisticsImpl implements NumericalIntervalStatistics {
	/**
	...
	public void setArithmethicMean(Measure newArithmethicMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_INTERVAL_STATISTICS__ARITHMETHIC_MEAN,
					oldArithmethicMean, arithmethicMean));
	}
	...
	public void setVariance(Measure newVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_INTERVAL_STATISTICS__VARIANCE,
	...
	public void setStandardDeviation(Measure newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_INTERVAL_STATISTICS__STANDARD_DEVIATION,
	...
	public void setSum(Measure newSum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.NUMERICAL_INTERVAL_STATISTICS__SUM,
					oldSum, sum));
	}
