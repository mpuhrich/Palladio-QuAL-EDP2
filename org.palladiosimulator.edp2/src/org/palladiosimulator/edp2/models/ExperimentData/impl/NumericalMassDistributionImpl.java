 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalMassDistributionImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalMassDistributionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalMassDistributionImpl#getNumericalNominalStatistics <em>Numerical Nominal Statistics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NumericalMassDistributionImpl extends EObjectImpl implements
	...
	public void setFrequency(long newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_MASS_DISTRIBUTION__FREQUENCY,
	...
	public void setValue(Measure newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.NUMERICAL_MASS_DISTRIBUTION__VALUE,
					oldValue, value));
	}
	...
	public NotificationChain basicSetNumericalNominalStatistics(
			NumericalNominalStatistics newNumericalNominalStatistics,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newNumericalNominalStatistics,
	 ...
	 */
	@Override
	public void setNumericalNominalStatistics(
			NumericalNominalStatistics newNumericalNominalStatistics) {
		if (newNumericalNominalStatistics != eInternalContainer()
			...
			if (newNumericalNominalStatistics != null)
				msgs = ((InternalEObject) newNumericalNominalStatistics)
						.eInverseAdd(
								this,
								ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION,
								NumericalNominalStatistics.class, msgs);
			msgs = basicSetNumericalNominalStatistics(
					newNumericalNominalStatistics, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.NUMERICAL_MASS_DISTRIBUTION__NUMERICAL_NOMINAL_STATISTICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetNumericalNominalStatistics(
