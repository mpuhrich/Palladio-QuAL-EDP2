 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalNominalStatisticsImpl#getNumberMeasurements <em>Number Measurements</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalNominalStatisticsImpl#getNumericalMassDistribution <em>Numerical Mass Distribution</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalNominalStatisticsImpl#getDataSeries <em>Data Series</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NumericalNominalStatisticsImpl extends IdentifierImpl implements
	...
	public void setNumberMeasurements(Measure newNumberMeasurements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMBER_MEASUREMENTS,
					oldNumberMeasurements, numberMeasurements));
	}
	...
	public EList<NumericalMassDistribution> getNumericalMassDistribution() {
		if (numericalMassDistribution == null) {
			numericalMassDistribution = new EObjectContainmentWithInverseEList<NumericalMassDistribution>(
					NumericalMassDistribution.class,
					this,
	...
	public DataSeries getDataSeries() {
		if (eContainerFeatureID() != ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__DATA_SERIES)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDataSeries(DataSeries newDataSeries,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newDataSeries,
	...
	public void setDataSeries(DataSeries newDataSeries) {
		if (newDataSeries != eInternalContainer()
				|| (eContainerFeatureID() != ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__DATA_SERIES && newDataSeries != null)) {
			...
			if (newDataSeries != null)
				msgs = ((InternalEObject) newDataSeries)
						.eInverseAdd(
								this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getNumericalMassDistribution())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION:
			return ((InternalEList<?>) getNumericalMassDistribution())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION:
			...
			getNumericalMassDistribution().addAll(
					(Collection<? extends NumericalMassDistribution>) newValue);
			return;
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__DATA_SERIES:
	...
	public boolean eIsSet(int featureID) {
		...
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION:
			return numericalMassDistribution != null
					&& !numericalMassDistribution.isEmpty();
		case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__DATA_SERIES:
