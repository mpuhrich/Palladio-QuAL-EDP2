 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalOrdinalStatisticsImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalOrdinalStatisticsImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalOrdinalStatisticsImpl#getMedian <em>Median</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalOrdinalStatisticsImpl#getPercentiles <em>Percentiles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NumericalOrdinalStatisticsImpl extends
		NumericalNominalStatisticsImpl implements NumericalOrdinalStatistics {
	/**
	...
	public void setMinimum(Measure newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__MINIMUM,
					oldMinimum, minimum));
	}
	...
	public void setMaximum(Measure newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__MAXIMUM,
					oldMaximum, maximum));
	}
	...
	public void setMedian(Measure newMedian) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__MEDIAN,
					oldMedian, median));
	}
	...
	public EList<NumericalPercentile> getPercentiles() {
		if (percentiles == null) {
			percentiles = new EObjectContainmentWithInverseEList<NumericalPercentile>(
					NumericalPercentile.class,
					this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__PERCENTILES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getPercentiles())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__PERCENTILES:
			return ((InternalEList<?>) getPercentiles()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExperimentDataPackage.NUMERICAL_ORDINAL_STATISTICS__PERCENTILES:
			...
			getPercentiles().addAll(
					(Collection<? extends NumericalPercentile>) newValue);
			return;
		}
