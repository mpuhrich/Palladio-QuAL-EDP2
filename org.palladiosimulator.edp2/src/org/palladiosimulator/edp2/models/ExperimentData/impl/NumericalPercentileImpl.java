 ...
 * @generated
 */
public class NumericalPercentileImpl extends IdentifierImpl implements
		NumericalPercentile {
	/**
	...
	public void setPercentile(double newPercentile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.NUMERICAL_PERCENTILE__PERCENTILE,
	...
	public void setValue(Measure newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.NUMERICAL_PERCENTILE__VALUE,
					oldValue, value));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrdinalStatistics(
			NumericalOrdinalStatistics newOrdinalStatistics,
	 ...
	 */
	@Override
	public void setOrdinalStatistics(
			NumericalOrdinalStatistics newOrdinalStatistics) {
		if (newOrdinalStatistics != eInternalContainer()
			...
			if (newOrdinalStatistics != null)
				msgs = ((InternalEObject) newOrdinalStatistics)
						.eInverseAdd(
								this,
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_PERCENTILE__ORDINAL_STATISTICS,
					newOrdinalStatistics, newOrdinalStatistics));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.NUMERICAL_PERCENTILE__ORDINAL_STATISTICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetOrdinalStatistics(
					(NumericalOrdinalStatistics) otherEnd, msgs);
		}
