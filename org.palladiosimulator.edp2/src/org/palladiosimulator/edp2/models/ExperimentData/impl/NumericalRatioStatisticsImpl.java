 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalRatioStatisticsImpl#getCoefficientOfVariation <em>Coefficient Of Variation</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalRatioStatisticsImpl#getGeometricMean <em>Geometric Mean</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.NumericalRatioStatisticsImpl#getHarmonicMean <em>Harmonic Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NumericalRatioStatisticsImpl extends
		NumericalIntervalStatisticsImpl implements NumericalRatioStatistics {
	/**
	...
	public void setGeometricMean(Measure newGeometricMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_RATIO_STATISTICS__GEOMETRIC_MEAN,
	...
	public void setHarmonicMean(Measure newHarmonicMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.NUMERICAL_RATIO_STATISTICS__HARMONIC_MEAN,
					oldHarmonicMean, harmonicMean));
	}
