 ...
 * Time</em>}</li>
 * <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.RunImpl#getMeasurements <em>
 * Measurements</em>}</li>
 * </ul>
 * </p>
 *
...
public abstract class RunImpl extends IdentifierImpl implements Run {
    ...
    public EList<Measurements> getMeasurements() {
        if (this.measurements == null) {
            this.measurements = new EObjectContainmentWithInverseEList<Measurements>(Measurements.class, this,
                    ExperimentDataPackage.RUN__MEASUREMENTS, ExperimentDataPackage.MEASUREMENTS__RUN);
        }
    ...
    public NotificationChain eInverseAdd(final InternalEObject otherEnd, final int featureID,
        ...
        case ExperimentDataPackage.RUN__MEASUREMENTS:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) this.getMeasurements())
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case ExperimentDataPackage.RUN__MEASUREMENTS:
            ...
            this.getMeasurements().addAll((Collection<? extends Measurements>) newValue);
            return;
        }
