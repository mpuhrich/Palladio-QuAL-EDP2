 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualMassDistributionImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualMassDistributionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualMassDistributionImpl#getTextualNominalStatistics <em>Textual Nominal Statistics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TextualMassDistributionImpl extends EObjectImpl implements
	...
	public void setFrequency(long newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExperimentDataPackage.TEXTUAL_MASS_DISTRIBUTION__FREQUENCY,
			...
			if (identifier != oldIdentifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							ExperimentDataPackage.TEXTUAL_MASS_DISTRIBUTION__IDENTIFIER,
	...
	public NotificationChain basicSetTextualNominalStatistics(
			TextualNominalStatistics newTextualNominalStatistics,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newTextualNominalStatistics,
	 ...
	 */
	@Override
	public void setTextualNominalStatistics(
			TextualNominalStatistics newTextualNominalStatistics) {
		if (newTextualNominalStatistics != eInternalContainer()
			...
			if (newTextualNominalStatistics != null)
				msgs = ((InternalEObject) newTextualNominalStatistics)
						.eInverseAdd(
								this,
								ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__MASS_DISTRIBUTION,
								TextualNominalStatistics.class, msgs);
			msgs = basicSetTextualNominalStatistics(
					newTextualNominalStatistics, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.TEXTUAL_MASS_DISTRIBUTION__TEXTUAL_NOMINAL_STATISTICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetTextualNominalStatistics(
