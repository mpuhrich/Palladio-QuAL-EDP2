 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualNominalStatisticsImpl#getNumberMeasurements <em>Number Measurements</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualNominalStatisticsImpl#getMassDistribution <em>Mass Distribution</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualNominalStatisticsImpl#getDataSeries <em>Data Series</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TextualNominalStatisticsImpl extends EObjectImpl implements
	...
	public void setNumberMeasurements(long newNumberMeasurements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__NUMBER_MEASUREMENTS,
	...
	public EList<TextualMassDistribution> getMassDistribution() {
		if (massDistribution == null) {
			massDistribution = new EObjectContainmentWithInverseEList<TextualMassDistribution>(
					TextualMassDistribution.class,
					this,
	...
	public DataSeries getDataSeries() {
		if (eContainerFeatureID() != ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES)
			return null;
	...
	public NotificationChain basicSetDataSeries(DataSeries newDataSeries,
		...
		msgs = eBasicSetContainer((InternalEObject) newDataSeries,
	...
	public void setDataSeries(DataSeries newDataSeries) {
		if (newDataSeries != eInternalContainer()
				|| (eContainerFeatureID() != ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES && newDataSeries != null)) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__MASS_DISTRIBUTION:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getMassDistribution())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__MASS_DISTRIBUTION:
			return ((InternalEList<?>) getMassDistribution()).basicRemove(
					otherEnd, msgs);
		case ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__MASS_DISTRIBUTION:
			...
			getMassDistribution().addAll(
					(Collection<? extends TextualMassDistribution>) newValue);
			return;
		case ExperimentDataPackage.TEXTUAL_NOMINAL_STATISTICS__DATA_SERIES:
