 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualOrdinalStatisticsImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualOrdinalStatisticsImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.ExperimentData.impl.TextualOrdinalStatisticsImpl#getMedian <em>Median</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TextualOrdinalStatisticsImpl extends TextualNominalStatisticsImpl
		implements TextualOrdinalStatistics {
	/**
			...
			if (minimum != oldMinimum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MINIMUM,
							oldMinimum, minimum));
			}
		}
		return minimum;
			...
			if (maximum != oldMaximum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MAXIMUM,
							oldMaximum, maximum));
			}
		}
		return maximum;
			...
			if (median != oldMedian) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MEDIAN,
							oldMedian, median));
			}
		}
		return median;
