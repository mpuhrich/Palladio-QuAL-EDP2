            ...
            if (minimum != oldMinimum) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MINIMUM, oldMinimum, minimum));
            }
        }
        return minimum;
    }
    ...
    public Identifier getMaximum() {
        if (maximum != null && maximum.eIsProxy()) {
            ...
            if (maximum != oldMaximum) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MAXIMUM, oldMaximum, maximum));
            }
        }
        return maximum;
    }
    ...
    public Identifier getMedian() {
        if (median != null && median.eIsProxy()) {
            ...
            if (median != oldMedian) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ExperimentDataPackage.TEXTUAL_ORDINAL_STATISTICS__MEDIAN, oldMedian, median));
            }
        }
        return median;
    }
