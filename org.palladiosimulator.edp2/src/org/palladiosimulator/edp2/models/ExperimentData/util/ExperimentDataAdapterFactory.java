...
public class ExperimentDataAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExperimentDataSwitch<Adapter> modelSwitch = new ExperimentDataSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEStringtoEObjectMapEntry(
		...
		@Override
		public Adapter caseNumericalNominalStatistics(
				NumericalNominalStatistics object) {
			return createNumericalNominalStatisticsAdapter();
		}

		@Override
		public Adapter caseNumericalMassDistribution(
				NumericalMassDistribution object) {
			return createNumericalMassDistributionAdapter();
		}

		@Override
		public Adapter caseFixedWidthAggregatedMeasurements(
		...
		@Override
		public Adapter caseTextualNominalStatistics(
				TextualNominalStatistics object) {
			return createTextualNominalStatisticsAdapter();
		}

		@Override
		public Adapter caseTextualMassDistribution(
				TextualMassDistribution object) {
		...
		@Override
		public <Q extends Quantity> Adapter caseDoubleBinaryMeasurements(
				DoubleBinaryMeasurements<Q> object) {
			return createDoubleBinaryMeasurementsAdapter();
		}

		@Override
		public Adapter caseNumericalIntervalStatistics(
				NumericalIntervalStatistics object) {
			return createNumericalIntervalStatisticsAdapter();
		}

		@Override
		public Adapter caseNumericalOrdinalStatistics(
				NumericalOrdinalStatistics object) {
		...
		@Override
		public Adapter caseIdentifierBasedMeasurements(
				IdentifierBasedMeasurements object) {
			return createIdentifierBasedMeasurementsAdapter();
		}

		@Override
		public Adapter caseNumericalRatioStatistics(
				NumericalRatioStatistics object) {
			return createNumericalRatioStatisticsAdapter();
		}

		@Override
		public Adapter caseSensorFrameworkV1DoubleBinaryMeasurements(
				SensorFrameworkV1DoubleBinaryMeasurements object) {
			return createSensorFrameworkV1DoubleBinaryMeasurementsAdapter();
		}

		@Override
		public Adapter caseSensorFrameworkV1IdentifierBasedMeasurements(
		...
		@Override
		public Adapter caseTextualOrdinalStatistics(
				TextualOrdinalStatistics object) {
		...
		@Override
		public Adapter caseExperimentGroupRun(ExperimentGroupRun object) {
			return createExperimentGroupRunAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.edp2.models.ExperimentData.ExperimentGroupRun <em>Experiment Group Run</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when inheritance will
	 * catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
