...
public class ExperimentDataAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ExperimentDataSwitch<Adapter> modelSwitch = new ExperimentDataSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseMeasurementsRange(final MeasurementsRange object) {
            return ExperimentDataAdapterFactory.this.createMeasurementsRangeAdapter();
        }
        ...
        @Override
        public Adapter caseMeasurements(final Measurements object) {
            return ExperimentDataAdapterFactory.this.createMeasurementsAdapter();
        }

        @Override
        public Adapter caseMeasure(final Measure object) {
            return ExperimentDataAdapterFactory.this.createMeasureAdapter();
        }
        ...
        public Adapter caseSensorFrameworkV1DoubleBinaryMeasurements(
                final SensorFrameworkV1DoubleBinaryMeasurements object) {
            return ExperimentDataAdapterFactory.this.createSensorFrameworkV1DoubleBinaryMeasurementsAdapter();
        }

        @Override
        public Adapter caseSensorFrameworkV1IdentifierBasedMeasurements(
                final SensorFrameworkV1IdentifierBasedMeasurements object) {
            return ExperimentDataAdapterFactory.this.createSensorFrameworkV1IdentifierBasedMeasurementsAdapter();
        }
     ...
     * <em>Measurements Range</em>}'. <!-- begin-user-doc --> This default implementation returns
