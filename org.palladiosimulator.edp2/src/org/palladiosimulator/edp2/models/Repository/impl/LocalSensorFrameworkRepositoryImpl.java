 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.Repository.impl.LocalSensorFrameworkRepositoryImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.Repository.impl.LocalSensorFrameworkRepositoryImpl#getImportSettings <em>Import Settings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LocalSensorFrameworkRepositoryImpl extends RepositoryImpl
		implements LocalSensorFrameworkRepository {
	/**
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.LOCAL_SENSOR_FRAMEWORK_REPOSITORY__URI,
					oldUri, uri));
	}
	...
	public void setImportSettings(String newImportSettings) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					RepositoryPackage.LOCAL_SENSOR_FRAMEWORK_REPOSITORY__IMPORT_SETTINGS,
					oldImportSettings, importSettings));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RepositoryPackage.LOCAL_SENSOR_FRAMEWORK_REPOSITORY__URI:
			return URI_EDEFAULT == null ? uri != null : !URI_EDEFAULT
					.equals(uri);
		case RepositoryPackage.LOCAL_SENSOR_FRAMEWORK_REPOSITORY__IMPORT_SETTINGS:
			return IMPORT_SETTINGS_EDEFAULT == null ? importSettings != null
					: !IMPORT_SETTINGS_EDEFAULT.equals(importSettings);
		}
