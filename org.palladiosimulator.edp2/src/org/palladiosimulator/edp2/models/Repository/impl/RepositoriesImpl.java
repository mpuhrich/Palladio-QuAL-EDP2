 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.Repository.impl.RepositoriesImpl#getAvailableRepositories <em>Available Repositories</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.Repository.impl.RepositoriesImpl#getCommonResourceSet <em>Common Resource Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoriesImpl extends EObjectImpl implements Repositories {
	...
	protected RepositoriesImpl() {
		...
		this.commonResourceSet = EmfModelXMIResourceFactoryImpl
				.createResourceSet();
	...
	public EList<Repository> getAvailableRepositories() {
		if (availableRepositories == null) {
			availableRepositories = new EObjectContainmentWithInverseEList<Repository>(
					Repository.class, this,
					RepositoryPackage.REPOSITORIES__AVAILABLE_REPOSITORIES,
					RepositoryPackage.REPOSITORY__REPOSITORIES);
		}
	...
	public ResourceSet getCommonResourceSet() {
		...
		if (this.commonResourceSet != null
				&& this.commonResourceSet instanceof EObject
				&& ((EObject) this.commonResourceSet).eIsProxy()) {
			final InternalEObject oldCommonResourceSet = (InternalEObject) this.commonResourceSet;
			this.commonResourceSet = (ResourceSet) this
					.eResolveProxy(oldCommonResourceSet);
			if (this.commonResourceSet != oldCommonResourceSet) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							RepositoryPackage.REPOSITORIES__COMMON_RESOURCE_SET,
							oldCommonResourceSet, this.commonResourceSet));
				}
			}
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.REPOSITORIES__AVAILABLE_REPOSITORIES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getAvailableRepositories())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case RepositoryPackage.REPOSITORIES__AVAILABLE_REPOSITORIES:
			return ((InternalEList<?>) getAvailableRepositories()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.REPOSITORIES__AVAILABLE_REPOSITORIES:
			...
			getAvailableRepositories().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RepositoryPackage.REPOSITORIES__AVAILABLE_REPOSITORIES:
			return availableRepositories != null
