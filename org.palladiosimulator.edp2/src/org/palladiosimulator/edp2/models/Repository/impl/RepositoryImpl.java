 ...
 * @generated
 */
public abstract class RepositoryImpl extends IdentifierImpl implements
		Repository {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRepositories(Repositories newRepositories,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newRepositories,
				RepositoryPackage.REPOSITORY__REPOSITORIES, msgs);
		return msgs;
	}
	...
	public void setReadOnly(boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.REPOSITORY__READ_ONLY, oldReadOnly,
					readOnly));
	}
	...
	public EList<Description> getDescriptions() {
		if (descriptions == null) {
			descriptions = new EObjectResolvingEList<Description>(
	...
	public EList<ExperimentGroup> getExperimentGroups() {
		if (experimentGroups == null) {
			experimentGroups = new EObjectWithInverseResolvingEList<ExperimentGroup>(
					ExperimentGroup.class, this,
	...
	public void resetExperimentGroups() {
		this.experimentGroups = new EObjectWithInverseResolvingEList<ExperimentGroup>(
				ExperimentGroup.class, this,
				RepositoryPackage.REPOSITORY__EXPERIMENT_GROUPS,
				ExperimentDataPackage.EXPERIMENT_GROUP__REPOSITORY);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.REPOSITORY__EXPERIMENT_GROUPS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getExperimentGroups())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case RepositoryPackage.REPOSITORY__EXPERIMENT_GROUPS:
			return ((InternalEList<?>) getExperimentGroups()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.REPOSITORY__EXPERIMENT_GROUPS:
			...
			getExperimentGroups().addAll(
					(Collection<? extends ExperimentGroup>) newValue);
			return;
		case RepositoryPackage.REPOSITORY__READ_ONLY:
		...
		case RepositoryPackage.REPOSITORY__DESCRIPTIONS:
			...
			getDescriptions().addAll(
					(Collection<? extends Description>) newValue);
			return;
		}
