...
public class RepositoryPackageImpl extends EPackageImpl implements
	...
	public EAttribute getLocalDirectoryRepository_Uri() {
		return (EAttribute) localDirectoryRepositoryEClass
	...
	public EAttribute getLocalMemoryRepository_Domain() {
		return (EAttribute) localMemoryRepositoryEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getRemoteCdoRepository_Url() {
		return (EAttribute) remoteCdoRepositoryEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getLocalSensorFrameworkRepository_Uri() {
		return (EAttribute) localSensorFrameworkRepositoryEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(localSensorFrameworkRepositoryEClass,
				LOCAL_SENSOR_FRAMEWORK_REPOSITORY__URI);
		createEAttribute(localSensorFrameworkRepositoryEClass,
				LOCAL_SENSOR_FRAMEWORK_REPOSITORY__IMPORT_SETTINGS);

		repositoriesEClass = createEClass(REPOSITORIES);
		createEReference(repositoriesEClass,
	...
	public void initializePackageContents() {
		...
		localDirectoryRepositoryEClass.getESuperTypes().add(
				this.getRepository());
		...
		localSensorFrameworkRepositoryEClass.getESuperTypes().add(
				this.getRepository());
		...
		initEClass(localDirectoryRepositoryEClass,
				LocalDirectoryRepository.class, "LocalDirectoryRepository",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLocalDirectoryRepository_Uri(),
				ecorePackage.getEString(), "uri", null, 1, 1,
				LocalDirectoryRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		EOperation op = addEOperation(localDirectoryRepositoryEClass,
				this.getFile(), "convertUriStringToFile", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "uriString", 1, 1,
				IS_UNIQUE, !IS_ORDERED);

		initEClass(fileEClass, File.class, "File", IS_ABSTRACT, IS_INTERFACE,
				!IS_GENERATED_INSTANCE_CLASS);

		initEClass(localMemoryRepositoryEClass, LocalMemoryRepository.class,
				"LocalMemoryRepository", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLocalMemoryRepository_Domain(),
				ecorePackage.getEString(), "domain", null, 1, 1,
				LocalMemoryRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(remoteCdoRepositoryEClass, RemoteCdoRepository.class,
				"RemoteCdoRepository", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRemoteCdoRepository_Url(), ecorePackage.getEString(),
				"url", null, 1, 1, RemoteCdoRepository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(localSensorFrameworkRepositoryEClass,
				LocalSensorFrameworkRepository.class,
				"LocalSensorFrameworkRepository", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLocalSensorFrameworkRepository_Uri(),
				ecorePackage.getEString(), "uri", null, 1, 1,
				LocalSensorFrameworkRepository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getLocalSensorFrameworkRepository_ImportSettings(),
				ecorePackage.getEString(), "importSettings", null, 1, 1,
				LocalSensorFrameworkRepository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(repositoriesEClass, Repositories.class, "Repositories",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRepositories_AvailableRepositories(),
				this.getRepository(), this.getRepository_Repositories(),
				"availableRepositories", null, 0, -1, Repositories.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getRepositories_CommonResourceSet(),
				this.getIResourceSet(), null, "commonResourceSet", null, 1, 1,
				Repositories.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(iResourceSetEClass, ResourceSet.class, "IResourceSet",
				IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);

		initEClass(measurementsDaoFactoryEClass, MeasurementsDaoFactory.class,
				"MeasurementsDaoFactory", IS_ABSTRACT, IS_INTERFACE,
				!IS_GENERATED_INSTANCE_CLASS);

		initEClass(metaDaoEClass, MetaDao.class, "MetaDao", IS_ABSTRACT,
		...
		initEReference(getRepository_Repositories(), this.getRepositories(),
				this.getRepositories_AvailableRepositories(), "repositories",
				null, 1, 1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRepository_ExperimentGroups(),
				theExperimentDataPackage.getExperimentGroup(),
				theExperimentDataPackage.getExperimentGroup_Repository(),
				"experimentGroups", null, 0, -1, Repository.class,
				IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getRepository_ReadOnly(), ecorePackage.getEBoolean(),
				"readOnly", null, 1, 1, Repository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getRepository_Descriptions(),
				theMetricSpecPackage.getDescription(), null, "descriptions",
				null, 0, -1, Repository.class, IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		addEOperation(repositoryEClass, null, "resetExperimentGroups", 1, 1,
				IS_UNIQUE, !IS_ORDERED);
