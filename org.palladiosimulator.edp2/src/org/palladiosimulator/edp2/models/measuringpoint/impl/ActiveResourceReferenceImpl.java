 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.ActiveResourceReferenceImpl#getActiveResource <em>Active Resource</em>}</li>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.ActiveResourceReferenceImpl#getReplicaID <em>Replica ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ActiveResourceReferenceImpl extends EObjectImpl implements ActiveResourceReference {
    /**
    ...
    protected EClass eStaticClass() {
        return MeasuringpointPackage.Literals.ACTIVE_RESOURCE_REFERENCE;
    }
        ...
        if (activeResource != null && activeResource.eIsProxy()) {
            ...
            if (activeResource != oldActiveResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasuringpointPackage.ACTIVE_RESOURCE_REFERENCE__ACTIVE_RESOURCE, oldActiveResource, activeResource));
            }
        }
    ...
    public void setActiveResource(ProcessingResourceSpecification newActiveResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.ACTIVE_RESOURCE_REFERENCE__ACTIVE_RESOURCE, oldActiveResource, activeResource));
    }
    ...
    public void setReplicaID(int newReplicaID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.ACTIVE_RESOURCE_REFERENCE__REPLICA_ID, oldReplicaID, replicaID));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case MeasuringpointPackage.ACTIVE_RESOURCE_REFERENCE__ACTIVE_RESOURCE:
                if (resolve) return getActiveResource();
                return basicGetActiveResource();
            case MeasuringpointPackage.ACTIVE_RESOURCE_REFERENCE__REPLICA_ID:
                return getReplicaID();
        }
