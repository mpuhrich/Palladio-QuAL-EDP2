 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.AssemblyPassiveResourceMeasuringPointImpl#getPassiveResource <em>Passive Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssemblyPassiveResourceMeasuringPointImpl extends AssemblyReferenceImpl implements AssemblyPassiveResourceMeasuringPoint {
    ...
    protected EClass eStaticClass() {
        return MeasuringpointPackage.Literals.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT;
    }
        ...
        if (passiveResource != null && passiveResource.eIsProxy()) {
            ...
            if (passiveResource != oldPassiveResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasuringpointPackage.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT__PASSIVE_RESOURCE, oldPassiveResource, passiveResource));
            }
        }
    ...
    public void setPassiveResource(PassiveResource newPassiveResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT__PASSIVE_RESOURCE, oldPassiveResource, passiveResource));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case MeasuringpointPackage.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT__PASSIVE_RESOURCE:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == PassiveResourceReference.class) {
            switch (derivedFeatureID) {
                case MeasuringpointPackage.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT__PASSIVE_RESOURCE: return MeasuringpointPackage.PASSIVE_RESOURCE_REFERENCE__PASSIVE_RESOURCE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == PassiveResourceReference.class) {
            switch (baseFeatureID) {
                case MeasuringpointPackage.PASSIVE_RESOURCE_REFERENCE__PASSIVE_RESOURCE: return MeasuringpointPackage.ASSEMBLY_PASSIVE_RESOURCE_MEASURING_POINT__PASSIVE_RESOURCE;
                default: return -1;
            }
        }
        if (baseClass == MeasuringPoint.class) {
