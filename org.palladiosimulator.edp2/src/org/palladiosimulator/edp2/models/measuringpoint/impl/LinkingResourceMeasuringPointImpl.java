 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.LinkingResourceMeasuringPointImpl#getLinkingResource <em>Linking Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkingResourceMeasuringPointImpl extends MeasuringPointImpl implements LinkingResourceMeasuringPoint {
    ...
    protected EClass eStaticClass() {
        return MeasuringpointPackage.Literals.LINKING_RESOURCE_MEASURING_POINT;
    }
        ...
        if (linkingResource != null && linkingResource.eIsProxy()) {
            ...
            if (linkingResource != oldLinkingResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasuringpointPackage.LINKING_RESOURCE_MEASURING_POINT__LINKING_RESOURCE, oldLinkingResource, linkingResource));
            }
        }
    ...
    public void setLinkingResource(LinkingResource newLinkingResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.LINKING_RESOURCE_MEASURING_POINT__LINKING_RESOURCE, oldLinkingResource, linkingResource));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case MeasuringpointPackage.LINKING_RESOURCE_MEASURING_POINT__LINKING_RESOURCE:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == LinkingResourceReference.class) {
            switch (derivedFeatureID) {
                case MeasuringpointPackage.LINKING_RESOURCE_MEASURING_POINT__LINKING_RESOURCE: return MeasuringpointPackage.LINKING_RESOURCE_REFERENCE__LINKING_RESOURCE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == LinkingResourceReference.class) {
            switch (baseFeatureID) {
                case MeasuringpointPackage.LINKING_RESOURCE_REFERENCE__LINKING_RESOURCE: return MeasuringpointPackage.LINKING_RESOURCE_MEASURING_POINT__LINKING_RESOURCE;
                default: return -1;
            }
        }
