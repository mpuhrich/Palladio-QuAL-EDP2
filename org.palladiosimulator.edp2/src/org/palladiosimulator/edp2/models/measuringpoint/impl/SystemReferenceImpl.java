 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.SystemReferenceImpl#getSystem <em>System</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class SystemReferenceImpl extends EObjectImpl implements SystemReference {
    /**
    ...
    protected EClass eStaticClass() {
        return MeasuringpointPackage.Literals.SYSTEM_REFERENCE;
    }
        ...
        if (system != null && system.eIsProxy()) {
            ...
            if (system != oldSystem) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasuringpointPackage.SYSTEM_REFERENCE__SYSTEM, oldSystem, system));
            }
        }
        return system;
    }
    ...
    public void setSystem(de.uka.ipd.sdq.pcm.system.System newSystem) {
        ...
        system = newSystem;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.SYSTEM_REFERENCE__SYSTEM, oldSystem, system));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case MeasuringpointPackage.SYSTEM_REFERENCE__SYSTEM:
