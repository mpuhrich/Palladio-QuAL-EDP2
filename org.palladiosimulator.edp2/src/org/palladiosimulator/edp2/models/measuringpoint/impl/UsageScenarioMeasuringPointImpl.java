 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.edp2.models.measuringpoint.impl.UsageScenarioMeasuringPointImpl#getUsageScenario <em>Usage Scenario</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UsageScenarioMeasuringPointImpl extends MeasuringPointImpl implements UsageScenarioMeasuringPoint {
    ...
    protected EClass eStaticClass() {
        return MeasuringpointPackage.Literals.USAGE_SCENARIO_MEASURING_POINT;
    }
        ...
        if (usageScenario != null && usageScenario.eIsProxy()) {
            ...
            if (usageScenario != oldUsageScenario) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasuringpointPackage.USAGE_SCENARIO_MEASURING_POINT__USAGE_SCENARIO, oldUsageScenario, usageScenario));
            }
        }
    ...
    public void setUsageScenario(UsageScenario newUsageScenario) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MeasuringpointPackage.USAGE_SCENARIO_MEASURING_POINT__USAGE_SCENARIO, oldUsageScenario, usageScenario));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case MeasuringpointPackage.USAGE_SCENARIO_MEASURING_POINT__USAGE_SCENARIO:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == UsageScenarioReference.class) {
            switch (derivedFeatureID) {
                case MeasuringpointPackage.USAGE_SCENARIO_MEASURING_POINT__USAGE_SCENARIO: return MeasuringpointPackage.USAGE_SCENARIO_REFERENCE__USAGE_SCENARIO;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == UsageScenarioReference.class) {
            switch (baseFeatureID) {
                case MeasuringpointPackage.USAGE_SCENARIO_REFERENCE__USAGE_SCENARIO: return MeasuringpointPackage.USAGE_SCENARIO_MEASURING_POINT__USAGE_SCENARIO;
                default: return -1;
            }
        }
