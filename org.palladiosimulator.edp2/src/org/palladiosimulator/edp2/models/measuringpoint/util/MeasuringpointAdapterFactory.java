...
public class MeasuringpointAdapterFactory extends AdapterFactoryImpl {
	...
	protected MeasuringpointSwitch<Adapter> modelSwitch = new MeasuringpointSwitch<Adapter>() {
		...
		@Override
		public Adapter caseResourceURIMeasuringPoint(
				ResourceURIMeasuringPoint object) {
			return createResourceURIMeasuringPointAdapter();
		}

		@Override
		public Adapter caseMeasuringPointRepository(
				MeasuringPointRepository object) {
			return createMeasuringPointRepositoryAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.edp2.models.measuringpoint.ResourceURIMeasuringPoint <em>Resource URI Measuring Point</em>}'.
	 * <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.edp2.models.measuringpoint.MeasuringPointRepository <em>Measuring Point Repository</em>}'.
	 * <!-- begin-user-doc -->
